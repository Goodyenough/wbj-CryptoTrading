...
- [ ] ?? live decision-state shadow logging??? paper 4h/daily ??????????? `active_positions`?capacity state?reference baseline decision?`atr_reclaim_0_35_shadow` decision ? opportunity id?
