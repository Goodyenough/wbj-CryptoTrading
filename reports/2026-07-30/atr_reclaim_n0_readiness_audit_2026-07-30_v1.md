---
created: 2026-07-30 00:57:33 CST
tags:
  - crypto
  - trading-system
...
Third-window retest can run, but opportunity-level mechanism evidence must be labeled approximate until stable baseline/variant opportunity IDs are available.
...
| git_commit | `c9b69448f7be2e78b69fe18100b670ffc856da24` |
| git_dirty | False |
...
| symbol_master | `reports\2026-07-30\dynamic_master_full_listing_enriched_2026-07-30_v2.json` |
| symbol_master_hash | `9b30bb18dfbb344c72d4232bc61b12955b1ce2c444cdd0bea71cf1a28c0e56ba` |
| symbol_master_count | 418 |
| symbol_master_created_at_utc | `2026-07-29T16:56:54+00:00` |
...
| Metric | Value |
|---|---:|
| source | `Binance current exchangeInfo tradable USDT spot symbols + Binance first available 1d kline listing_dates` |
| listing_dates_present | True |
| listed_after_start_count | 201 |
| missing_listing_dates_count | 0 |
| listed_after_start_examples | `0GUSDT:2025-09-22, 1000CATUSDT:2024-12-17, 1000CHEEMSUSDT:2025-02-09, 1000SATSUSDT:2023-12-12, 1MBABYDOGEUSDT:2024-09-16, 2ZUSDT:2025-10-02, ACEUSDT:2023-12-18, ACTUSDT:2024-11-11, ACXUSDT:2024-12-06, AEVOUSDT:2024-03-13` |
...
| `git_clean` | `pass` |
| `listing_dates` | `pass` |
| `listed_after_start` | `warn_symbols_listed_after_window_start` |
...
| `D:\OneDrive - whut.edu.cn\文档\CryptoTradingPorjects\reports\2026-07-30\abtest_dynamic_universe_atr_reclaim_0_35_2023-07-01_2024-07-01_v1.md` |

## N1 Gate

`n0_conditional_pass_with_alignment_warning`

## Recommended Next Action

N1 may run as the fixed `0.35` system-level retest, but mechanism evidence must be labeled approximate until strict opportunity IDs and capacity-state fields are available.
...
```json
{
  ...
  "symbol_master_path": "reports\\2026-07-30\\dynamic_master_full_listing_enriched_2026-07-30_v2.json",
  "symbol_master_source": "Binance current exchangeInfo tradable USDT spot symbols + Binance first available 1d kline listing_dates",
  "symbol_master_created_at_utc": "2026-07-29T16:56:54+00:00",
  "symbol_master_hash": "9b30bb18dfbb344c72d4232bc61b12955b1ce2c444cdd0bea71cf1a28c0e56ba",
  "settings_hash": "be7ec39ec21f6a838571511cb2cd0e290263031b521a9a07a6fb70164b8ef4bf",
  "experiments_hash": "7e6eca2609546d94293162870df6cc6ab8795666845b58facd979b698917dbe1",
  ...
  "listed_after_start_examples": [
    "0GUSDT:2025-09-22",
    "1000CATUSDT:2024-12-17",
    "1000CHEEMSUSDT:2025-02-09",
    "1000SATSUSDT:2023-12-12",
    "1MBABYDOGEUSDT:2024-09-16",
    "2ZUSDT:2025-10-02",
    "ACEUSDT:2023-12-18",
    "ACTUSDT:2024-11-11",
    "ACXUSDT:2024-12-06",
