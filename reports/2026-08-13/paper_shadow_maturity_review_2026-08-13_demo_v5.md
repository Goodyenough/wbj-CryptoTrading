...
| plan-linked decision rows | 108 |
| mature terminal rows | 0 |
| right-censored open rows | 108 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260813_041004_a8b0a96e` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-13T04:10:04Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 76 |
| `reference_baseline` | 76 |
| `research_incumbent` | 76 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 108 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:108` | `capacity_available:108` | `unknown:108` |
...
| `decision_level_unknown` | 108 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 228 |
