# atr_reclaim prospective shadow maturity review v7
...
| plan-linked decision rows | 114 |
| mature terminal rows | 0 |
| right-censored open rows | 114 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 114 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:114` | `capacity_available:114` | `unknown:114` |
...
| `decision_level_unknown` | 114 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 249 |
