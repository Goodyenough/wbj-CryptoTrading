...
| plan-linked decision rows | 111 |
| mature terminal rows | 0 |
| right-censored open rows | 111 |
| unknown plan rows | 0 |
...
- latest_scan: `c453a9b4f0d0` at `2026-08-11T12:06:13+00:00`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-13T08:10:03Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 77 |
| `reference_baseline` | 77 |
| `research_incumbent` | 77 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 111 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:111` | `capacity_available:111` | `unknown:111` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 120 |
| `decision_level_unknown` | 111 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 231 |
