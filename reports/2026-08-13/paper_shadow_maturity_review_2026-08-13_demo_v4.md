...
| plan-linked decision rows | 105 |
| mature terminal rows | 0 |
| right-censored open rows | 105 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260813_001003_84c58549` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-13T00:10:03Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 75 |
| `reference_baseline` | 75 |
| `research_incumbent` | 75 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 105 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:105` | `capacity_available:105` | `unknown:105` |
...
| `decision_level_unknown` | 105 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 225 |
