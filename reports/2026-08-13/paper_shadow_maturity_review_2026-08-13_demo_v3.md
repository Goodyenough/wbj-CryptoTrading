...
| plan-linked decision rows | 102 |
| mature terminal rows | 0 |
| right-censored open rows | 102 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260812_201003_ecdf40a5` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-12T20:10:03Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 74 |
| `reference_baseline` | 74 |
| `research_incumbent` | 74 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 102 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:102` | `capacity_available:102` | `unknown:102` |
...
| `decision_level_unknown` | 102 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 222 |
