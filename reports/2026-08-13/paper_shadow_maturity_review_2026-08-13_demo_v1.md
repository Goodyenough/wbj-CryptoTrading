...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 99 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:99` | `capacity_available:99` | `unknown:99` |
...
| `decision_level_unknown` | 99 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 219 |
