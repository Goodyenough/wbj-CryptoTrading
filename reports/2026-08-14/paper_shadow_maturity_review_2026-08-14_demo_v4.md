...
| plan-linked decision rows | 126 |
| mature terminal rows | 0 |
| right-censored open rows | 126 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 126 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:126` | `capacity_available:126` | `unknown:126` |
...
| `decision_level_unknown` | 126 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 261 |
