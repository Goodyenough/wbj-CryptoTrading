...
| plan-linked decision rows | 117 |
| mature terminal rows | 0 |
| right-censored open rows | 117 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 117 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:117` | `capacity_available:117` | `unknown:117` |
...
| `decision_level_unknown` | 117 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 252 |
