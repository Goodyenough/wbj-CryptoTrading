...
| plan-linked decision rows | 120 |
| mature terminal rows | 0 |
| right-censored open rows | 120 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 120 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:120` | `capacity_available:120` | `unknown:120` |
...
| `decision_level_unknown` | 120 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 255 |
