# atr_reclaim prospective shadow maturity review v6
...
| decisions | 282 |
| opportunities | 51 |
| candidate-only rows | 150 |
| plan-linked decision rows | 132 |
| mature terminal rows | 0 |
| right-censored open rows | 132 |
| unknown plan rows | 0 |
...
- latest_scan: `0bd63f946d48` at `2026-08-14T12:06:05+00:00`
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 132 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:132` | `capacity_available:132` | `unknown:132` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 150 |
| `decision_level_unknown` | 132 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 282 |
