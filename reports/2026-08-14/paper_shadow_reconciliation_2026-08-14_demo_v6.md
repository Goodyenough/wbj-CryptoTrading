# Paper Shadow Decision-State Reconciliation v6
...
| independent symbols | 21 |
| candidate observations | 30 |
| counterfactual outcomes | 90 |
| terminal counterfactual outcomes | 14 |

## Pre-Attribution Gate

| Requirement | Current | Minimum |
|---|---:|---:|
| complete opportunities | 51 | 10 |
| mature terminal opportunities | 0 | 5 |
| independent symbols | 21 | 3 |
| controls_paper rows | 0 | 0 |
| incomplete opportunities | 0 | 0 |

## Run Context

- latest_daily_run: `20260814_120503_c96b7b47` status=`success`
- latest_4h_run: `20260814_081002_d44c98cc` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-14T12:06:05Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 94 |
| `reference_baseline` | 94 |
| `research_incumbent` | 94 |
...
|---|---:|
| `candidate_level` | 150 |
| `paper_4h_decision` | 132 |

## By Decision

| Decision | Count |
|---|---:|
| `candidate_registered` | 150 |
| `reject` | 132 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 132 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
