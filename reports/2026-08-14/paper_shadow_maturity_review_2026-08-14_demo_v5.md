...
| plan-linked decision rows | 129 |
| mature terminal rows | 0 |
| right-censored open rows | 129 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 129 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:129` | `capacity_available:129` | `unknown:129` |
...
| `decision_level_unknown` | 129 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 264 |
