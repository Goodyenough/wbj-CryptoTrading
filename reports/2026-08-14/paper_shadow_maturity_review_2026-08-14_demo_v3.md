# atr_reclaim prospective shadow maturity review v3
...
| decisions | 258 |
| opportunities | 46 |
| candidate-only rows | 135 |
| plan-linked decision rows | 123 |
| mature terminal rows | 0 |
| right-censored open rows | 123 |
| unknown plan rows | 0 |
...
- latest_scan: `4ac624d4005e` at `2026-08-13T12:06:23+00:00`
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 123 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:123` | `capacity_available:123` | `unknown:123` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 135 |
| `decision_level_unknown` | 123 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 258 |
