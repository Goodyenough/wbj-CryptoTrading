...
| independent symbols | 20 |
| candidate observations | 25 |
| counterfactual outcomes | 75 |
| terminal counterfactual outcomes | 12 |

## Pre-Attribution Gate

| Requirement | Current | Minimum |
|---|---:|---:|
| complete opportunities | 46 | 10 |
| mature terminal opportunities | 0 | 5 |
| independent symbols | 20 | 3 |
| controls_paper rows | 0 | 0 |
| incomplete opportunities | 0 | 0 |

## Run Context

- latest_daily_run: `20260813_120503_202d006a` status=`success`
- latest_4h_run: `20260813_201004_caaac0d3` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-13T20:10:04Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 85 |
| `reference_baseline` | 85 |
| `research_incumbent` | 85 |
...
|---|---:|
| `candidate_level` | 135 |
| `paper_4h_decision` | 120 |

## By Decision

| Decision | Count |
|---|---:|
| `candidate_registered` | 135 |
| `reject` | 120 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 120 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
