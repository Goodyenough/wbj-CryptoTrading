...
| plan-linked decision rows | 33 |
| mature terminal rows | 0 |
| right-censored open rows | 33 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 33 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:33` | `capacity_available:33` | `unknown:33` |
...
| `decision_level_unknown` | 33 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 78 |
