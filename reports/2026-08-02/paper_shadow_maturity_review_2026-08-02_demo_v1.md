...
| plan-linked decision rows | 30 |
| mature terminal rows | 0 |
| right-censored open rows | 30 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 30 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:30` | `capacity_available:30` | `unknown:30` |
