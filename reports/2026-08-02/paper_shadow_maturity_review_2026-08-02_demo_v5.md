...
| plan-linked decision rows | 42 |
| mature terminal rows | 0 |
| right-censored open rows | 42 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 42 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:42` | `capacity_available:42` | `unknown:42` |
...
| `decision_level_unknown` | 42 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 87 |
