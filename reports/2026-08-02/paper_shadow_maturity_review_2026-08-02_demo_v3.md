...
| plan-linked decision rows | 36 |
| mature terminal rows | 0 |
| right-censored open rows | 36 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 36 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:36` | `capacity_available:36` | `unknown:36` |
...
| `decision_level_unknown` | 36 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 81 |
