---
created: 2026-07-12 00:10:20 CST
tags:
  - crypto
  - trading-system
  - paper-trading
...
- 报告时间：2026-07-12 00:10:20 CST
- Run ID：`20260711_161003_14653c50`
...
- BTC 7d 涨跌：+1.54%（阈值 -3.0%）
- ETH 7d 涨跌：+1.75%（阈值 -5.0%）
- BTC 日线趋势：✗ 趋势未确认
- ETH 日线趋势：✗ 趋势未确认
...
| Unrealized PnL | -36.98 USDT |
| Entry reclaim blocks | 129 |
...
|---|---|---:|---|---|---|---|
| `ONDOUSDT` | WATCHING | 129 | 2026-06-11 20:47:37 CST | 2026-07-12 00:10:20 CST | still_waiting | Watching: entry zone touched, but 4h close has not reclaimed entry_high. |
...
|---|---|---|---|---|---:|---:|---:|---|---|
| 2026-07-12 00:10:20 CST | RECLAIM_PENDING_SET | `ONDOUSDT` | WATCHING | WATCHING | 0.33280 | 0.33845 | 0.33845 | 2026-07-11T15:59:59Z | Entry zone touched (price=0.33280) but 4h close 0.33440 < entry_high 0.41157; waiting for reclaim. |

## 当前观察与持仓

| Status | Symbol | Last | Entry Zone | Entry | Stop | TP1 | TP2 | Qty | Unrealized | Notes |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| ENTERED | `WLDUSDT` | 0.40600 | 0.43071 - 0.46770 | 0.45830 | 0.31687 | 0.71386 | 0.84619 | 707.09 | -36.98 | Paper entry triggered inside entry zone. |
| WATCHING | `ONDOUSDT` | 0.33280 | 0.39450 - 0.41157 | n/a | 0.33845 | 0.53222 | 0.59681 | n/a | 0.00 | Watching: entry zone touched, but 4h close has not reclaimed entry_high. |
