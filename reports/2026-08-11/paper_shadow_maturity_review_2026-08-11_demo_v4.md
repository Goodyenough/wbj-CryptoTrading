...
| plan-linked decision rows | 81 |
| mature terminal rows | 0 |
| right-censored open rows | 81 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 81 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:81` | `capacity_available:81` | `unknown:81` |
...
| `decision_level_unknown` | 81 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 186 |
