...
| plan-linked decision rows | 78 |
| mature terminal rows | 0 |
| right-censored open rows | 78 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 78 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:78` | `capacity_available:78` | `unknown:78` |
