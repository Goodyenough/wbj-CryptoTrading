...
| plan-linked decision rows | 75 |
| mature terminal rows | 0 |
| right-censored open rows | 75 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 75 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:75` | `capacity_available:75` | `unknown:75` |
