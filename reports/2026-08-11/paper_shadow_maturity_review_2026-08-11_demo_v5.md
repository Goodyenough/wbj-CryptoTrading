...
| plan-linked decision rows | 84 |
| mature terminal rows | 0 |
| right-censored open rows | 84 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 84 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:84` | `capacity_available:84` | `unknown:84` |
...
| `decision_level_unknown` | 84 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 189 |
