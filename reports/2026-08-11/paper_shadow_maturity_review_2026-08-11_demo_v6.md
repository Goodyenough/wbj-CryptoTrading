...
| plan-linked decision rows | 87 |
| mature terminal rows | 0 |
| right-censored open rows | 87 |
| unknown plan rows | 0 |
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-11T12:06:13Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 69 |
| `reference_baseline` | 69 |
| `research_incumbent` | 69 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 87 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:87` | `capacity_available:87` | `unknown:87` |
...
| `decision_level_unknown` | 87 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 207 |
