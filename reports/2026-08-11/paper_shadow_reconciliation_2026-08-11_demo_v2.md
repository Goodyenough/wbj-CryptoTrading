...
|---|---:|---:|
| complete opportunities | 36 | 10 |
| mature terminal opportunities | 0 | 5 |
| independent symbols | 18 | 3 |
...
- latest_4h_run: `20260810_201003_38a04872` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-10T20:10:03Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 60 |
| `reference_baseline` | 60 |
| `research_incumbent` | 60 |
...
|---|---:|
| `candidate_level` | 105 |
| `paper_4h_decision` | 75 |

## By Decision

| Decision | Count |
|---|---:|
| `candidate_registered` | 105 |
| `reject` | 75 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 75 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
