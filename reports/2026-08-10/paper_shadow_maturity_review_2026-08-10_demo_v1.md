...
| plan-linked decision rows | 54 |
| mature terminal rows | 0 |
| right-censored open rows | 54 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260809_161004_49af4a38` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-09T16:10:04Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 48 |
| `reference_baseline` | 48 |
| `research_incumbent` | 48 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 54 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:54` | `capacity_available:54` | `unknown:54` |
...
| `decision_level_unknown` | 54 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 144 |
