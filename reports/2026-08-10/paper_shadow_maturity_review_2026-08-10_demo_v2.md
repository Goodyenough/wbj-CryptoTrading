...
| plan-linked decision rows | 57 |
| mature terminal rows | 0 |
| right-censored open rows | 57 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260809_201004_857ce98f` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-09T20:10:04Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 49 |
| `reference_baseline` | 49 |
| `research_incumbent` | 49 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 57 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:57` | `capacity_available:57` | `unknown:57` |
...
| `decision_level_unknown` | 57 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 147 |
