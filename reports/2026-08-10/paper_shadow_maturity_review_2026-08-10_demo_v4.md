...
| plan-linked decision rows | 63 |
| mature terminal rows | 0 |
| right-censored open rows | 63 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 63 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:63` | `capacity_available:63` | `unknown:63` |
...
| `decision_level_unknown` | 63 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 153 |
