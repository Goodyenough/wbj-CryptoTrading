...
- latest_4h_run: `20260810_081004_bfe79393` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-10T12:06:38Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 58 |
| `reference_baseline` | 58 |
| `research_incumbent` | 58 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 69 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
