...
| plan-linked decision rows | 69 |
| mature terminal rows | 0 |
| right-censored open rows | 69 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 69 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:69` | `capacity_available:69` | `unknown:69` |
...
| `decision_level_unknown` | 69 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 174 |
