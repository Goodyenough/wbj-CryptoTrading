...
| plan-linked decision rows | 66 |
| mature terminal rows | 0 |
| right-censored open rows | 66 |
| unknown plan rows | 0 |
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-10T08:10:04Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 52 |
| `reference_baseline` | 52 |
| `research_incumbent` | 52 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 66 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:66` | `capacity_available:66` | `unknown:66` |
...
| `decision_level_unknown` | 66 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 156 |
