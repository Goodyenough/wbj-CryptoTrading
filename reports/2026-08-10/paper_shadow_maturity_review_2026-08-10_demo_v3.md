...
| plan-linked decision rows | 60 |
| mature terminal rows | 0 |
| right-censored open rows | 60 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260810_001005_e64cdccf` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-10T00:10:05Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 50 |
| `reference_baseline` | 50 |
| `research_incumbent` | 50 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 60 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:60` | `capacity_available:60` | `unknown:60` |
