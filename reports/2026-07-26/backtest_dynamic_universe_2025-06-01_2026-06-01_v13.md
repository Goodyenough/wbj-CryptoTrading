...
# 回测报告 2025-06-01 至 2026-06-01 v13
...
| Avg R（平均R倍数） | 0.08 |
| Net return（净收益率） | 1.36% |
| Max drawdown（最大回撤） | 2,183.67 / 18.62% |
| Intrabar max drawdown（K线内最大回撤） | 2,143.99 / 18.40% |
| TP1 touched rate（第一止盈触达率） | 40.38% |
| TP2 close rate（第二止盈平仓率） | 13.46% |
| Stop rate（止损率） | 86.54% |
| Fee drag（手续费拖累） | 99.20 USDT |
| Tail max single loss（最大单笔亏损） | -118.08 USDT |
| CAGR（年化复合收益率） | 1.36% |
| Sharpe（夏普比率） | 0.16 |
| Sortino（索提诺比率） | 0.17 |
...
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 14.04 | -103.84 | -104.70 | -1.01 | 0.86 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 0.28 | 0.26 | 5,312.03 | -102.84 | -104.82 | -1.03 | 1.99 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 105,888.73 | 98,767.81 | 0.01 | -102.64 | -104.68 | -1.03 | 2.03 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,716.18 | 0.57 | 110.96 | 108.83 | 1.08 | 2.13 | EMA20 trailing stop hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 41.92 | -106.37 | -107.54 | -1.02 | 1.17 | Stop loss hit. |
| `APTUSDT` | STOPPED（已止损） | 2025-06-26T16:00:00+00:00 | 4.75 | 3.81 | 106.43 | -100.09 | -100.70 | -1.01 | 0.61 | Stop loss hit. |
| `WUSDT` | STOPPED（已止损） | 2025-06-27T00:00:00+00:00 | 0.07 | 0.08 | 11,065.57 | 126.55 | 125.37 | 1.26 | 1.17 | EMA20 trailing stop hit. |
| `BTCUSDT` | CLOSED（已按TP2平仓） | 2025-06-28T00:00:00+00:00 | 107,328.13 | 117,240.50 | 0.03 | 324.43 | 321.49 | 3.16 | 2.94 | TP2 hit; paper trade closed. |
| `TRXUSDT` | STOPPED（已止损） | 2025-06-28T04:00:00+00:00 | 0.27 | 0.29 | 12,728.93 | 137.59 | 132.56 | 1.30 | 5.02 | EMA20 trailing stop hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-28T12:00:00+00:00 | 7.02 | 6.62 | 239.62 | -96.34 | -98.60 | -1.04 | 2.26 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-06-29T08:00:00+00:00 | 648.24 | 680.91 | 2.44 | 79.85 | 77.55 | 1.70 | 2.30 | EMA20 trailing stop hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T04:00:00+00:00 | 7.30 | 8.89 | 161.69 | 257.00 | 255.95 | 2.55 | 1.05 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 41,510,064.50 | 264.34 | 263.51 | 2.44 | 0.84 | TP2 hit; paper trade closed. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-07-11T16:00:00+00:00 | 305.18 | 279.25 | 4.26 | -110.50 | -112.21 | -1.03 | 1.71 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-07-12T00:00:00+00:00 | 2.94 | 3.17 | 555.90 | 124.46 | 122.05 | 1.11 | 2.42 | EMA20 trailing stop hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-07-13T00:00:00+00:00 | 0.30 | 0.32 | 7,615.68 | 141.22 | 137.88 | 1.24 | 3.34 | EMA20 trailing stop hit. |
| `TAOUSDT` | STOPPED（已止损） | 2025-07-15T04:00:00+00:00 | 406.16 | 367.53 | 2.91 | -112.34 | -113.88 | -1.02 | 1.54 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-18T20:00:00+00:00 | 17.64 | 21.05 | 50.06 | 170.73 | 169.32 | 1.47 | 1.41 | EMA20 trailing stop hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-07-19T00:00:00+00:00 | 0.75 | 0.67 | 1,473.32 | -115.96 | -117.40 | -1.02 | 1.43 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-22T20:00:00+00:00 | 766.05 | 813.76 | 2.17 | 103.73 | 101.29 | 0.90 | 2.44 | EMA20 trailing stop hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 1.04 | 1,398.81 | 90.62 | 88.63 | 0.79 | 2.00 | EMA20 trailing stop hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-07-24T20:00:00+00:00 | 113.15 | 104.88 | 14.02 | -115.98 | -118.08 | -1.03 | 2.10 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.42 | -114.91 | -117.04 | -1.03 | 2.13 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,308.60 | -112.34 | -113.35 | -1.02 | 1.01 | Stop loss hit. |
| `MEMEUSDT` | STOPPED（已止损） | 2025-08-01T04:00:00+00:00 | 0.00 | 0.00 | 339,013.92 | -108.46 | -109.27 | -1.01 | 0.81 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-08-05T12:00:00+00:00 | 566.03 | 506.28 | 1.79 | -107.17 | -108.49 | -1.02 | 1.31 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-05T20:00:00+00:00 | 118.90 | 102.48 | 6.51 | -106.89 | -107.87 | -1.02 | 0.98 | Stop loss hit. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2025-08-07T20:00:00+00:00 | 0.22 | 0.28 | 4,414.67 | 293.19 | 292.31 | 2.71 | 0.88 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-08-11T08:00:00+00:00 | 11.03 | 11.54 | 148.31 | 74.46 | 72.10 | 0.66 | 2.37 | EMA20 trailing stop hit. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-12T04:00:00+00:00 | 5.51 | 5.15 | 308.76 | -112.64 | -114.91 | -1.03 | 2.27 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-08-14T20:00:00+00:00 | 0.90 | 0.75 | 733.12 | -109.74 | -110.56 | -1.01 | 0.82 | Stop loss hit. |
| `PYTHUSDT` | STOPPED（已止损） | 2025-09-11T00:00:00+00:00 | 0.17 | 0.15 | 6,206.35 | -112.97 | -114.35 | -1.02 | 1.38 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 5.79 | -109.88 | -111.55 | -1.03 | 1.67 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 54.36 | -110.02 | -111.63 | -1.03 | 1.61 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.85 | 0.77 | 1,384.43 | -110.20 | -111.73 | -1.02 | 1.53 | Stop loss hit. |
| `OGUSDT` | STOPPED（已止损） | 2025-10-07T20:00:00+00:00 | 16.48 | 12.90 | 29.30 | -105.00 | -105.57 | -1.01 | 0.57 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-01-16T00:00:00+00:00 | 0.31 | 0.29 | 7,871.39 | -104.58 | -107.86 | -1.05 | 3.28 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.43 | -104.53 | -106.40 | -1.03 | 1.88 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-16T20:00:00+00:00 | 934.62 | 908.92 | 4.16 | -106.99 | -112.33 | -1.09 | 5.34 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 10.23 | -103.91 | -104.96 | -1.02 | 1.05 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 20,705.81 | -97.51 | -97.89 | -1.01 | 0.38 | Stop loss hit. |
| `TRXUSDT` | CLOSED（已按TP2平仓） | 2026-04-15T00:00:00+00:00 | 0.32 | 0.35 | 11,336.36 | 337.87 | 334.81 | 3.43 | 3.06 | TP2 hit; paper trade closed. |
| `BNBUSDT` | STOPPED（已止损） | 2026-04-15T04:00:00+00:00 | 615.92 | 672.56 | 2.71 | 153.45 | 150.96 | 1.56 | 2.49 | EMA20 trailing stop hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2026-04-15T12:00:00+00:00 | 9.46 | 8.78 | 143.75 | -98.55 | -100.36 | -1.03 | 1.81 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2026-04-15T16:00:00+00:00 | 9.17 | 9.79 | 159.24 | 98.97 | 96.82 | 0.99 | 2.14 | EMA20 trailing stop hit. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-15T20:00:00+00:00 | 0.09 | 0.11 | 15,104.65 | 213.90 | 212.67 | 2.54 | 1.23 | TP2 hit; paper trade closed. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-08T04:00:00+00:00 | 0.00 | 0.00 | 563,185,196.95 | 64.12 | 60.79 | 0.58 | 3.33 | EMA20 trailing stop hit. |
| `TAOUSDT` | STOPPED（已止损） | 2026-05-08T16:00:00+00:00 | 309.94 | 276.51 | 3.18 | -106.30 | -107.58 | -1.02 | 1.27 | Stop loss hit. |
| `LUNCUSDT` | STOPPED（已止损） | 2026-05-08T16:00:00+00:00 | 0.00 | 0.00 | 9,489,251.14 | -106.75 | -107.91 | -1.02 | 1.16 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-05-13T08:00:00+00:00 | 0.35 | 0.37 | 11,239.25 | 219.76 | 214.01 | 2.06 | 5.74 | EMA20 trailing stop hit. |
| `DOGEUSDT` | STOPPED（已止损） | 2026-05-13T20:00:00+00:00 | 0.11 | 0.10 | 13,960.19 | -104.73 | -106.81 | -1.03 | 2.09 | Stop loss hit. |

## 回测结束仍开放

| Symbol（交易对） | Status（状态） | Entry（入场价） | Qty（数量） | Unrealized Handling（未实现盈亏处理） | Notes（备注） |
|---|---|---:|---:|---|---|
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 1,856.34 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-07-26T09:39:36+00:00",
