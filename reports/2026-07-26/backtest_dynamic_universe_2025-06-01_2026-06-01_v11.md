...
- 最终权益：10,199.33 USDT
- 净收益：1.99%
- 代码 commit：`35fcd8eec1af10bf5df5ff3a7ab7007df01d2fcf`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
| Open trades（仍开放持仓） | 1 |
| Win rate（胜率） | 38.89% |
| Profit factor（盈利因子） | 1.08 |
| Avg R（平均R倍数） | 0.08 |
| Net return（净收益率） | 1.99% |
| Max drawdown（最大回撤） | 2,197.19 / 18.62% |
| Intrabar max drawdown（K线内最大回撤） | 2,157.26 / 18.40% |
| TP1 touched rate（第一止盈触达率） | 38.89% |
| TP2 close rate（第二止盈平仓率） | 14.81% |
| Stop rate（止损率） | 85.19% |
| Fee drag（手续费拖累） | 102.48 USDT |
| Tail max single loss（最大单笔亏损） | -118.82 USDT |
| CAGR（年化复合收益率） | 1.99% |
| Sharpe（夏普比率） | 0.20 |
| Sortino（索提诺比率） | 0.20 |
| Exposure（持仓暴露时间） | 56.89% |
| Turnover（换手率） | 7.99 |
...
| `WUSDT` | STOPPED（已止损） | 2025-06-27T00:00:00+00:00 | 0.07 | 0.08 | 11,134.57 | 127.34 | 126.16 | 1.26 | 1.18 | EMA20 trailing stop hit. |
| `BTCUSDT` | CLOSED（已按TP2平仓） | 2025-06-28T00:00:00+00:00 | 107,328.13 | 117,240.50 | 0.03 | 326.45 | 323.49 | 3.16 | 2.96 | TP2 hit; paper trade closed. |
| `TRXUSDT` | STOPPED（已止损） | 2025-06-28T04:00:00+00:00 | 0.27 | 0.29 | 12,808.31 | 138.45 | 133.39 | 1.30 | 5.06 | EMA20 trailing stop hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-28T12:00:00+00:00 | 7.02 | 6.62 | 241.12 | -96.94 | -99.21 | -1.04 | 2.27 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-06-29T08:00:00+00:00 | 648.24 | 680.91 | 2.46 | 80.34 | 78.03 | 1.70 | 2.31 | EMA20 trailing stop hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T04:00:00+00:00 | 7.30 | 8.89 | 162.70 | 258.60 | 257.55 | 2.55 | 1.05 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 41,768,910.10 | 265.99 | 265.15 | 2.44 | 0.84 | TP2 hit; paper trade closed. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-07-11T16:00:00+00:00 | 305.18 | 279.25 | 4.29 | -111.18 | -112.91 | -1.03 | 1.72 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-07-12T00:00:00+00:00 | 2.94 | 3.17 | 559.37 | 125.24 | 122.81 | 1.11 | 2.43 | EMA20 trailing stop hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-07-13T00:00:00+00:00 | 0.30 | 0.32 | 7,663.17 | 142.10 | 138.74 | 1.24 | 3.36 | EMA20 trailing stop hit. |
| `TAOUSDT` | STOPPED（已止损） | 2025-07-15T04:00:00+00:00 | 406.16 | 367.53 | 2.93 | -113.04 | -114.59 | -1.02 | 1.55 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-18T20:00:00+00:00 | 17.64 | 21.05 | 50.37 | 171.79 | 170.38 | 1.47 | 1.42 | EMA20 trailing stop hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-07-19T00:00:00+00:00 | 0.75 | 0.67 | 1,482.50 | -116.69 | -118.13 | -1.02 | 1.44 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-22T20:00:00+00:00 | 766.05 | 813.76 | 2.19 | 104.38 | 101.92 | 0.90 | 2.45 | EMA20 trailing stop hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 1.04 | 1,407.53 | 91.19 | 89.18 | 0.79 | 2.01 | EMA20 trailing stop hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-07-24T20:00:00+00:00 | 113.15 | 104.88 | 14.10 | -116.70 | -118.82 | -1.03 | 2.12 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.43 | -115.63 | -117.77 | -1.03 | 2.15 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,316.76 | -113.04 | -114.06 | -1.02 | 1.01 | Stop loss hit. |
| `MEMEUSDT` | STOPPED（已止损） | 2025-08-01T04:00:00+00:00 | 0.00 | 0.00 | 341,127.92 | -109.13 | -109.95 | -1.01 | 0.81 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-08-05T12:00:00+00:00 | 566.03 | 506.28 | 1.80 | -107.84 | -109.16 | -1.02 | 1.32 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-05T20:00:00+00:00 | 118.90 | 102.48 | 6.55 | -107.56 | -108.54 | -1.02 | 0.98 | Stop loss hit. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2025-08-07T20:00:00+00:00 | 0.22 | 0.28 | 4,442.20 | 295.02 | 294.13 | 2.71 | 0.89 | TP2 hit; paper trade closed. |
| `BNBUSDT` | STOPPED（已止损） | 2025-08-11T00:00:00+00:00 | 803.70 | 833.48 | 3.19 | 95.02 | 91.34 | 0.83 | 3.69 | EMA20 trailing stop hit. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-12T04:00:00+00:00 | 5.51 | 5.15 | 311.21 | -113.53 | -115.82 | -1.03 | 2.29 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-08-14T20:00:00+00:00 | 0.90 | 0.75 | 738.94 | -110.61 | -111.44 | -1.01 | 0.82 | Stop loss hit. |
| `PYTHUSDT` | STOPPED（已止损） | 2025-09-11T00:00:00+00:00 | 0.17 | 0.15 | 6,255.42 | -113.86 | -115.26 | -1.02 | 1.39 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 5.84 | -110.75 | -112.43 | -1.03 | 1.69 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 54.79 | -110.89 | -112.52 | -1.03 | 1.62 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.85 | 0.77 | 1,395.39 | -111.07 | -112.61 | -1.02 | 1.54 | Stop loss hit. |
| `OGUSDT` | STOPPED（已止损） | 2025-10-07T20:00:00+00:00 | 16.48 | 12.90 | 29.54 | -105.83 | -106.41 | -1.01 | 0.58 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-01-16T00:00:00+00:00 | 0.31 | 0.29 | 7,934.09 | -105.42 | -108.72 | -1.05 | 3.30 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.43 | -105.29 | -107.18 | -1.03 | 1.89 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2026-01-16T20:00:00+00:00 | 144.68 | 138.02 | 15.81 | -105.39 | -108.49 | -1.05 | 3.10 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-16T20:00:00+00:00 | 934.62 | 908.92 | 4.20 | -107.86 | -113.25 | -1.09 | 5.38 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 1.36 | -13.83 | -13.97 | -1.02 | 0.14 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 20,835.27 | -98.12 | -98.51 | -1.01 | 0.38 | Stop loss hit. |
| `TRXUSDT` | CLOSED（已按TP2平仓） | 2026-04-15T00:00:00+00:00 | 0.32 | 0.35 | 11,407.17 | 339.98 | 336.91 | 3.43 | 3.08 | TP2 hit; paper trade closed. |
| `BNBUSDT` | STOPPED（已止损） | 2026-04-15T04:00:00+00:00 | 615.92 | 672.56 | 2.73 | 154.41 | 151.90 | 1.56 | 2.51 | EMA20 trailing stop hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2026-04-15T12:00:00+00:00 | 9.46 | 8.78 | 144.64 | -99.17 | -100.99 | -1.03 | 1.82 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2026-04-15T16:00:00+00:00 | 9.17 | 9.79 | 160.24 | 99.59 | 97.43 | 0.99 | 2.16 | EMA20 trailing stop hit. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-15T20:00:00+00:00 | 0.09 | 0.11 | 15,199.00 | 215.24 | 214.00 | 2.54 | 1.24 | TP2 hit; paper trade closed. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-08T04:00:00+00:00 | 0.00 | 0.00 | 566,702,937.48 | 64.52 | 61.17 | 0.58 | 3.35 | EMA20 trailing stop hit. |
| `TAOUSDT` | STOPPED（已止损） | 2026-05-08T16:00:00+00:00 | 309.94 | 276.51 | 3.20 | -106.97 | -108.25 | -1.02 | 1.28 | Stop loss hit. |
| `LUNCUSDT` | STOPPED（已止损） | 2026-05-08T16:00:00+00:00 | 0.00 | 0.00 | 9,548,522.44 | -107.42 | -108.59 | -1.02 | 1.17 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-05-13T08:00:00+00:00 | 0.35 | 0.37 | 11,309.47 | 221.13 | 215.35 | 2.06 | 5.78 | EMA20 trailing stop hit. |
| `DOGEUSDT` | STOPPED（已止损） | 2026-05-13T20:00:00+00:00 | 0.11 | 0.10 | 14,019.70 | -105.17 | -107.27 | -1.03 | 2.10 | Stop loss hit. |

## 回测结束仍开放

| Symbol（交易对） | Status（状态） | Entry（入场价） | Qty（数量） | Unrealized Handling（未实现盈亏处理） | Notes（备注） |
|---|---|---:|---:|---|---|
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 1,867.93 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `LINKUSDT` | EXPIRED（观察计划过期） | 2025-07-04T04:00:00+00:00 | 13.50 - 13.64 | 55.55 | Backtest WATCHING plan expired before entry. |
...
| `AAVEUSDT` | EXPIRED（观察计划过期） | 2025-07-08T12:00:00+00:00 | 280.66 - 284.48 | 65.57 | Backtest WATCHING plan expired before entry. |
| `FLOKIUSDT` | EXPIRED（观察计划过期） | 2025-07-09T16:00:00+00:00 | 0.00 - 0.00 | 62.97 | Backtest WATCHING plan expired before entry. |
| `TRXUSDT` | EXPIRED（观察计划过期） | 2025-07-09T16:00:00+00:00 | 0.29 - 0.29 | 56.47 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2025-07-13T20:00:00+00:00 | 0.20 - 0.20 | 67.90 | Backtest WATCHING plan expired before entry. |
...
| `CAKEUSDT` | EXPIRED（观察计划过期） | 2025-07-26T12:00:00+00:00 | 2.71 - 2.76 | 62.14 | Backtest WATCHING plan expired before entry. |
...
| `PENGUUSDT` | INVALIDATED（未入场前失效） | 2025-07-28T04:00:00+00:00 | 0.04 - 0.04 | 78.85 | Plan invalidated before entry: current price is below stop loss. |
...
| `BTCUSDT` | INVALIDATED（未入场前失效） | 2025-07-30T16:00:00+00:00 | 117,184.65 - 117,684.73 | 37.13 | Plan invalidated before entry: current price is below stop loss. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-09-11T00:00:00+00:00 | 882.25 - 886.32 | 67.42 | Backtest WATCHING plan expired before entry. |
...
| `AVAXUSDT` | EXPIRED（观察计划过期） | 2025-09-13T20:00:00+00:00 | 28.97 - 29.42 | 73.61 | Backtest WATCHING plan expired before entry. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-09-14T04:00:00+00:00 | 917.85 - 922.70 | 62.08 | Backtest WATCHING plan expired before entry. |
...
| `AVAXUSDT` | EXPIRED（观察计划过期） | 2025-09-17T00:00:00+00:00 | 29.69 - 30.17 | 65.65 | Backtest WATCHING plan expired before entry. |
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-09-17T08:00:00+00:00 | 936.31 - 942.42 | 68.94 | Backtest WATCHING plan expired before entry. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-07-26T09:12:29+00:00",
