...
| plan-linked decision rows | 138 |
| mature terminal rows | 0 |
| right-censored open rows | 138 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 138 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:138` | `capacity_available:138` | `unknown:138` |
...
| `decision_level_unknown` | 138 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 288 |
