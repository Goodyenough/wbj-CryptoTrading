...
| plan-linked decision rows | 135 |
| mature terminal rows | 0 |
| right-censored open rows | 135 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 135 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:135` | `capacity_available:135` | `unknown:135` |
