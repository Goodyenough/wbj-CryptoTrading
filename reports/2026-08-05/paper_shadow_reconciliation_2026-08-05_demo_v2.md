...
| independent symbols | 15 |
| candidate observations | 5 |
| counterfactual outcomes | 15 |
...
|---|---:|---:|
| complete opportunities | 26 | 10 |
| mature terminal opportunities | 0 | 5 |
| independent symbols | 15 | 3 |
| controls_paper rows | 0 | 0 |
| incomplete opportunities | 0 | 0 |

## Run Context

- latest_daily_run: `20260805_142117_1c0e47c5` status=`success`
- latest_4h_run: `20260804_081002_358fffdc` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-05T14:23:11Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 41 |
| `reference_baseline` | 41 |
| `research_incumbent` | 41 |
...
|---|---:|
| `candidate_level` | 75 |
| `paper_4h_decision` | 48 |

## By Decision

| Decision | Count |
|---|---:|
| `candidate_registered` | 75 |
| `reject` | 48 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 48 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
