---
created: 2026-05-19 23:25:16 CST
tags:
  - crypto
  - trading-system
  - market-scan
scan_id: 5e1db9afc001
---

# Crypto 市场扫描报告 5e1db9afc001

- 报告时间：2026-05-19 23:25:16 CST
...
|---:|---|---|---:|---:|---:|---|---:|---|
| 1 | `NEAR` | 回踩支撑/4h EMA 附近 | 1.5671 - 1.5989 | 1.4470 | 1.8551 | 1.9911 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 2 | `ZEC` | 回踩支撑/4h EMA 附近 | 542.75 - 555.58 | 489.02 | 669.45 | 729.60 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 3 | `ONDO` | 回踩支撑/4h EMA 附近 | 0.35390 - 0.36268 | 0.32820 | 0.41847 | 0.44856 或跌破 4h 关键支撑 | 2.00-3.00 | 只观察 |
| 4 | `TRX` | 回踩支撑/4h EMA 附近 | 0.35351 - 0.35433 | 0.34751 | 0.36673 | 0.38140 或跌破 4h 关键支撑 | 2.00-4.29 | 可考虑 |
| 5 | `TON` | 趋势中，等回调入场 | 1.8741 - 1.9380 | 1.8143 | 2.1641 | 2.2507 或跌破 4h 关键支撑 | 2.81-3.75 | 只观察 |

## 候选币说明

### 1. NEAR `NEARUSDT`

![NEARUSDT evidence chart](charts/5e1db9afc001_NEARUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +7.68%，7d +4.81%，4h RSI 60.31，24h 成交额 $31.1M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 1.6110 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +7.68% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +4.81% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.5640 | 判断短期趋势支撑 |
| 4h EMA50 | 1.5432 | 判断中期趋势支撑 |
| 1d EMA20 | 1.5040 | 判断日线趋势 |
| 1d EMA50 | 1.4108 | 判断日线趋势 |
| 4h RSI14 | 60.31 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.5640`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.5671 - 1.5989`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.4470`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `1.8551`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `1.9911`。
...
| 2026-05-19T12:00+00:00 | 1.5980 | 1.6370 | 1.5950 | 1.6110 | $4.5M | 23037 |

### 2. ZEC `ZECUSDT`

![ZECUSDT evidence chart](charts/5e1db9afc001_ZECUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +6.10%，7d +1.75%，4h RSI 65.82，24h 成交额 $138.6M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 557.92 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +6.10% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +1.75% | 判断短线趋势是否延续 |
| 4h EMA20 | 541.67 | 判断短期趋势支撑 |
| 4h EMA50 | 534.17 | 判断中期趋势支撑 |
| 1d EMA20 | 508.38 | 判断日线趋势 |
| 1d EMA50 | 424.36 | 判断日线趋势 |
| 4h RSI14 | 65.82 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `541.67`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `542.75 - 555.58`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `489.02`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `669.45`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `729.60`。
...
| 2026-05-19T12:00+00:00 | 554.43 | 568.55 | 551.00 | 557.86 | $18.1M | 72992 |

### 3. ONDO `ONDOUSDT`

![ONDOUSDT evidence chart](charts/5e1db9afc001_ONDOUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +6.54%，7d -7.40%，4h RSI 51.51，24h 成交额 $34.1M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.36160 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +6.54% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | -7.40% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.36316 | 判断短期趋势支撑 |
| 4h EMA50 | 0.36728 | 判断中期趋势支撑 |
| 1d EMA20 | 0.35319 | 判断日线趋势 |
| 1d EMA50 | 0.31619 | 判断日线趋势 |
| 4h RSI14 | 51.51 | 判断是否过热/过弱 |
| 4h ATR14 | 0.01502 | 推导止损和入场缓冲 |
| 最近 18 根 4h 最低点 | 0.33320 | 支撑/止损参考 |
| 最近 36 根 4h 最高点 | 0.41570 | TP/压力参考 |
| 支撑位 | 0.35319 | 入场区间推导基础 |

#### 交易计划推导

- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `0.35319`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `0.35390 - 0.36268`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `0.32820`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `0.41847`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `0.44856`。
...
| 2026-05-19T12:00+00:00 | 0.36730 | 0.37250 | 0.35910 | 0.36150 | $5.5M | 42742 |

### 4. TRX `TRXUSDT`

![TRXUSDT evidence chart](charts/5e1db9afc001_TRXUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +0.17%，7d +2.07%，4h RSI 50.99，24h 成交额 $40.9M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.35470 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +0.17% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +2.07% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.35512 | 判断短期趋势支撑 |
| 4h EMA50 | 0.35266 | 判断中期趋势支撑 |
| 1d EMA20 | 0.34686 | 判断日线趋势 |
| 1d EMA50 | 0.33301 | 判断日线趋势 |
| 4h RSI14 | 50.99 | 判断是否过热/过弱 |
...
| 2026-05-19T12:00+00:00 | 0.35520 | 0.35680 | 0.35410 | 0.35470 | $7.2M | 16527 |

### 5. TON `TONUSDT`

![TONUSDT evidence chart](charts/5e1db9afc001_TONUSDT.svg)

- 入选原因：趋势中，等回调入场；24h +1.55%，7d -15.02%，4h RSI 51.52，24h 成交额 $37.5M。
- 交易失效条件：跌破 1.8142571 或 4h 收盘重新失守关键支撑。
- 主要风险：日线趋势未完全确认；7d 趋势未确认。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 1.9580 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +1.55% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | -15.02% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.9845 | 判断短期趋势支撑 |
| 4h EMA50 | 2.0354 | 判断中期趋势支撑 |
| 1d EMA20 | 1.9640 | 判断日线趋势 |
| 1d EMA50 | 1.7207 | 判断日线趋势 |
| 4h RSI14 | 51.52 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.8590`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.8741 - 1.9380`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.8143`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `2.1641`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `2.2507`。
...
| 2026-05-19T12:00+00:00 | 1.9840 | 2.0210 | 1.9550 | 1.9580 | $5.3M | 45256 |
...
[
  {
    ...
    "base_asset": "NEAR",
    "price": 1.611,
    "score": 69.16987305239348,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 1.5670956443866282,
    "entry_high": 1.5989177089686908,
    "stop_loss": 1.446965,
    "take_profit_1": 1.855090030032978,
    "take_profit_2": 1.9911317067106373,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 7.682,
    "pct_3d": 7.975871313672922,
    "pct_7d": 4.814573845152892,
    "quote_volume_24h": 31098973.1052,
    "trades_24h": 173365,
    "high_low_range_24h": 11.505016722408023,
    "rsi_1h": 49.12280701754383,
    "rsi_4h": 60.31331592689297,
    "ema20_4h": 1.5639677089686908,
    "ema50_4h": 1.5431832619022057,
    "ema20_1d": 1.5039666055437326,
    "ema50_1d": 1.4108127653303781,
    "atr_4h": 0.049928571428571385,
    "macd_hist_4h": 0.012839990377183476,
    "volume_ratio_24h": 1.2019654607711066,
    "support_level": 1.5639677089686908,
    "recent_low_4h_18": 1.469,
    "recent_high_4h_36": 1.667,
    "distance_to_support_pct": 3.0072418222958808,
  ...
  },
  {
    ...
    "base_asset": "ZEC",
    "price": 557.92,
    "score": 68.96870687257683,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 542.7501742067196,
    "entry_high": 555.5818405256682,
    "stop_loss": 489.02295000000004,
    "take_profit_1": 669.4521220985819,
    "take_profit_2": 729.5951794647758,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 6.1,
    "pct_3d": 10.724775740255609,
    "pct_7d": 1.7489468021081978,
    "quote_volume_24h": 138554386.8241,
    "trades_24h": 496429,
    "high_low_range_24h": 9.885924317736006,
    "rsi_1h": 41.54009184033904,
    "rsi_4h": 65.82114102675095,
    "ema20_4h": 541.6668405256682,
    "ema50_4h": 534.1650637279614,
    "ema20_1d": 508.3805678797157,
    "ema50_1d": 424.3635378136393,
    "atr_4h": 19.878571428571416,
    "macd_hist_4h": 4.894810836761129,
    "volume_ratio_24h": 1.2351513537931735,
    "support_level": 541.6668405256682,
    "recent_low_4h_18": 496.47,
    "recent_high_4h_36": 577.0,
    "distance_to_support_pct": 3.0005823244706242,
  ...
  },
  {
    ...
    "base_asset": "ONDO",
    "price": 0.3616,
    "score": 45.08931631571829,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 0.3538966195668729,
    "entry_high": 0.3626847999999999,
    "stop_loss": 0.328202,
    "take_profit_1": 0.41846812935030925,
    "take_profit_2": 0.44855683913374567,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 6.541,
    "pct_3d": 3.9976991659476546,
    "pct_7d": -7.400768245838673,
    "quote_volume_24h": 34074164.3877,
    "trades_24h": 269563,
    "high_low_range_24h": 18.383658969804607,
    "rsi_1h": 36.79245283018865,
    "rsi_4h": 51.51253241140882,
    "ema20_4h": 0.36316036009861596,
    "ema50_4h": 0.36728009645928605,
    "ema20_1d": 0.3531902390886955,
    "ema50_1d": 0.31619134113194797,
    "atr_4h": 0.015021428571428571,
    "macd_hist_4h": 0.004241949149217182,
    "volume_ratio_24h": 2.4388580327147604,
    "support_level": 0.3531902390886955,
    "recent_low_4h_18": 0.3332,
    "recent_high_4h_36": 0.4157,
    "distance_to_support_pct": 2.381085313400333,
  ...
  },
  {
    ...
    "pct_24h": 0.169,
    "pct_3d": 0.05641748942173397,
    "pct_7d": 2.0719424460431846,
    "quote_volume_24h": 40857703.34456,
    "trades_24h": 80985,
    "high_low_range_24h": 1.0734463276836248,
    "rsi_1h": 42.25352112676051,
    "rsi_4h": 50.99337748344379,
    "ema20_4h": 0.3551165158031949,
    "ema50_4h": 0.35265845175931715,
    "ema20_1d": 0.34685786377652117,
    "ema50_1d": 0.33301214279618957,
    "atr_4h": 0.0021785714285714186,
    "macd_hist_4h": -0.00023419066260767685,
    "volume_ratio_24h": 1.042801615403579,
    "support_level": 0.3528,
    "recent_low_4h_18": 0.3528,
    "recent_high_4h_36": 0.3584,
    "distance_to_support_pct": 0.5385487528344779,
  ...
  },
  {
    ...
    "base_asset": "TON",
    "price": 1.958,
    "score": 19.71475344269864,
    "setup": "趋势中，等回调入场",
    "verdict": "只观察",
    "entry_low": 1.87415,
    "entry_high": 1.9380357142857143,
    "stop_loss": 1.814257142857143,
    "take_profit_1": 2.164125,
    "take_profit_2": 2.25069,
    "risk_reward_1": 2.8097145523839138,
    "risk_reward_2": 3.752321692463251,
    "pct_24h": 1.555,
    "pct_3d": 0.6683804627249268,
    "pct_7d": -15.017361111111105,
    "quote_volume_24h": 37538410.85573,
    "trades_24h": 309963,
    "high_low_range_24h": 8.957569408067044,
    "rsi_1h": 46.415094339622605,
    "rsi_4h": 51.52129817444217,
    "ema20_4h": 1.9844692467059675,
    "ema50_4h": 2.035438443638916,
    "ema20_1d": 1.9639934251499933,
    "ema50_1d": 1.720740505670603,
    "atr_4h": 0.07985714285714292,
    "macd_hist_4h": 0.017024258925654602,
    "volume_ratio_24h": 0.9134241033327251,
    "support_level": 1.859,
    "recent_low_4h_18": 1.859,
    "recent_high_4h_36": 2.175,
    "distance_to_support_pct": 5.3254437869822535,
    ...
    "invalidation": "跌破 1.8142571 或 4h 收盘重新失守关键支撑",
    "recent_4h_klines": [
      {
        "open_time_utc": "2026-05-13T16:00+00:00",
        "open": 2.091,
