---
created: 2026-05-19 22:35:20 CST
tags:
  - crypto
  - trading-system
  - market-scan
scan_id: 644f2c98e0a5
---

# Crypto 市场扫描报告 644f2c98e0a5

- 扫描时间：2026-05-19 22:35:20 CST
...
|---:|---|---|---:|---:|---:|---|---:|---|
| 1 | `ZEC` | 回踩支撑/4h EMA 附近 | 542.46 - 555.25 | 489.02 | 668.52 | 728.36 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 2 | `NEAR` | 回踩支撑/4h EMA 附近 | 1.5665 - 1.5983 | 1.4470 | 1.8534 | 1.9888 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 3 | `ONDO` | 回踩支撑/4h EMA 附近 | 0.36446 - 0.36840 | 0.32820 | 0.44289 | 0.48112 或跌破 4h 关键支撑 | 2.00-3.00 | 只观察 |
| 4 | `TRX` | 回踩支撑/4h EMA 附近 | 0.35351 - 0.35429 | 0.34751 | 0.36667 | 0.38134 或跌破 4h 关键支撑 | 2.00-4.30 | 只观察 |
| 5 | `TON` | 回踩支撑/4h EMA 附近 | 1.9698 - 1.9829 | 1.8311 | 2.2669 | 2.4122 或跌破 4h 关键支撑 | 2.00-3.00 | 只观察 |

## 候选币说明

### 1. ZEC `ZECUSDT`

![ZECUSDT evidence chart](charts/644f2c98e0a5_ZECUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +5.76%，7d +1.93%，4h RSI 64.91，24h 成交额 $136.3M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 554.86 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +5.76% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +1.93% | 判断短线趋势是否延续 |
| 4h EMA20 | 541.38 | 判断短期趋势支撑 |
| 4h EMA50 | 534.05 | 判断中期趋势支撑 |
| 1d EMA20 | 508.09 | 判断日线趋势 |
| 1d EMA50 | 424.25 | 判断日线趋势 |
| 4h RSI14 | 64.91 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `541.38`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `542.46 - 555.25`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `489.02`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `668.52`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `728.36`。
...
| 2026-05-19T12:00+00:00 | 554.43 | 568.55 | 551.94 | 554.86 | $12.9M | 52691 |

### 2. NEAR `NEARUSDT`

![NEARUSDT evidence chart](charts/644f2c98e0a5_NEARUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +7.23%，7d +3.48%，4h RSI 59.68，24h 成交额 $31.0M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 1.6050 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +7.23% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +3.48% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.5634 | 判断短期趋势支撑 |
| 4h EMA50 | 1.5429 | 判断中期趋势支撑 |
| 1d EMA20 | 1.5034 | 判断日线趋势 |
| 1d EMA50 | 1.4106 | 判断日线趋势 |
| 4h RSI14 | 59.68 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.5634`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.5665 - 1.5983`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.4470`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `1.8534`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `1.9888`。
...
| 2026-05-19T12:00+00:00 | 1.5980 | 1.6370 | 1.5950 | 1.6050 | $3.6M | 17463 |

### 3. ONDO `ONDOUSDT`

![ONDOUSDT evidence chart](charts/644f2c98e0a5_ONDOUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +7.71%，7d -5.72%，4h RSI 54.31，24h 成交额 $33.1M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.36730 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +7.71% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | -5.72% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.36373 | 判断短期趋势支撑 |
| 4h EMA50 | 0.36752 | 判断中期趋势支撑 |
| 1d EMA20 | 0.35376 | 判断日线趋势 |
| 1d EMA50 | 0.31643 | 判断日线趋势 |
| 4h RSI14 | 54.31 | 判断是否过热/过弱 |
| 4h ATR14 | 0.01481 | 推导止损和入场缓冲 |
| 最近 18 根 4h 最低点 | 0.33320 | 支撑/止损参考 |
| 最近 36 根 4h 最高点 | 0.41570 | TP/压力参考 |
| 支撑位 | 0.36373 | 入场区间推导基础 |

#### 交易计划推导

- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `0.36373`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `0.36446 - 0.36840`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `0.32820`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `0.44289`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `0.48112`。
...
| 2026-05-19T12:00+00:00 | 0.36730 | 0.37250 | 0.36210 | 0.36750 | $4.0M | 31829 |

### 4. TRX `TRXUSDT`

![TRXUSDT evidence chart](charts/644f2c98e0a5_TRXUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h -0.53%，7d +1.95%，4h RSI 52.03，24h 成交额 $43.9M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.35500 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | -0.53% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +1.95% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.35515 | 判断短期趋势支撑 |
| 4h EMA50 | 0.35267 | 判断中期趋势支撑 |
| 1d EMA20 | 0.34689 | 判断日线趋势 |
| 1d EMA50 | 0.33302 | 判断日线趋势 |
| 4h RSI14 | 52.03 | 判断是否过热/过弱 |
| 4h ATR14 | 0.0021214286 | 推导止损和入场缓冲 |
...
- 入场区间 = 支撑位附近 + ATR 缓冲 = `0.35351 - 0.35429`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `0.34751`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `0.36667`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `0.38134`。
...
| 2026-05-19T12:00+00:00 | 0.35520 | 0.35680 | 0.35490 | 0.35500 | $4.9M | 12849 |

### 5. TON `TONUSDT`

![TONUSDT evidence chart](charts/644f2c98e0a5_TONUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +1.33%，7d -15.37%，4h RSI 53.70，24h 成交额 $40.1M。
...
| 7d 涨跌 | -15.37% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.9864 | 判断短期趋势支撑 |
| 4h EMA50 | 2.0362 | 判断中期趋势支撑 |
| 1d EMA20 | 1.9659 | 判断日线趋势 |
| 1d EMA50 | 1.7215 | 判断日线趋势 |
| 4h RSI14 | 53.70 | 判断是否过热/过弱 |
| 4h ATR14 | 0.07864 | 推导止损和入场缓冲 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.9659`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.9698 - 1.9829`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.8311`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `2.2669`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `2.4122`。
...
| 2026-05-19T12:00+00:00 | 1.9840 | 2.0210 | 1.9720 | 1.9780 | $4.0M | 32000 |
...
[
  {
    ...
    "base_asset": "ZEC",
    "price": 554.86,
    "score": 68.89192271687412,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 542.4638884924339,
    "entry_high": 555.2491262399539,
    "stop_loss": 489.02295000000004,
    "take_profit_1": 668.5236220985817,
    "take_profit_2": 728.3571794647755,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 5.757,
    "pct_3d": 10.737237057438232,
    "pct_7d": 1.9288706003380174,
    "quote_volume_24h": 136317731.29397,
    "trades_24h": 487449,
    "high_low_range_24h": 10.5258117038598,
    "rsi_1h": 42.16740088105727,
    "rsi_4h": 64.90978579681808,
    "ema20_4h": 541.3811262399539,
    "ema50_4h": 534.0474166691379,
    "ema20_1d": 508.09485359400145,
    "ema50_1d": 424.2458907548158,
    "atr_4h": 19.811428571428557,
    "macd_hist_4h": 4.703357845308105,
    "volume_ratio_24h": 1.2657209477093796,
    "support_level": 541.3811262399539,
    "recent_low_4h_18": 496.47,
    "recent_high_4h_36": 577.0,
    "distance_to_support_pct": 2.4897199231271205,
  ...
  },
  {
    ...
    "base_asset": "NEAR",
    "price": 1.605,
    "score": 68.05062835919318,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 1.5665230729580566,
    "entry_high": 1.5983462803972621,
    "stop_loss": 1.446965,
    "take_profit_1": 1.853374030032978,
    "take_profit_2": 1.9888437067106373,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 7.229,
    "pct_3d": 7.718120805369133,
    "pct_7d": 3.481624758220514,
    "quote_volume_24h": 30967934.7115,
    "trades_24h": 174533,
    "high_low_range_24h": 12.104909213180903,
    "rsi_1h": 43.07692307692309,
    "rsi_4h": 59.68169761273211,
    "ema20_4h": 1.563396280397262,
    "ema50_4h": 1.5429479677845586,
    "ema20_1d": 1.503395176972304,
    "ema50_1d": 1.410577471212731,
    "atr_4h": 0.049928571428571385,
    "macd_hist_4h": 0.012457084394277607,
    "volume_ratio_24h": 1.1970839468985925,
    "support_level": 1.563396280397262,
    "recent_low_4h_18": 1.469,
    "recent_high_4h_36": 1.667,
    "distance_to_support_pct": 2.661111589197729,
  ...
  },
  {
    ...
    "base_asset": "ONDO",
    "price": 0.3673,
    "score": 47.09415830192309,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 0.3644592522473846,
    "entry_high": 0.36840189999999995,
    "stop_loss": 0.328202,
    "take_profit_1": 0.44288772837107687,
    "take_profit_2": 0.48111630449476916,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 7.713,
    "pct_3d": 5.850144092219023,
    "pct_7d": -5.723819301848043,
    "quote_volume_24h": 33135006.99432,
    "trades_24h": 263830,
    "high_low_range_24h": 18.383658969804607,
    "rsi_1h": 35.040431266846355,
    "rsi_4h": 54.31425976385105,
    "ema20_4h": 0.3637317886700445,
    "ema50_4h": 0.3675153905769331,
    "ema20_1d": 0.35376166766012407,
    "ema50_1d": 0.316426635249595,
    "atr_4h": 0.014807142857142856,
    "macd_hist_4h": 0.004624855132123184,
    "volume_ratio_24h": 2.336524011886405,
    "support_level": 0.3637317886700445,
    "recent_low_4h_18": 0.3332,
    "recent_high_4h_36": 0.4157,
    "distance_to_support_pct": 0.9810006826739937,
  ...
  },
  {
    ...
    "base_asset": "TRX",
    "price": 0.355,
    "score": 40.33843515900344,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 0.3535056,
    "entry_high": 0.354285,
    "stop_loss": 0.347508,
    "take_profit_1": 0.3666699000000001,
    "take_profit_2": 0.38133669600000014,
    "risk_reward_1": 2.0,
    "risk_reward_2": 4.2962434831618905,
    "pct_24h": -0.532,
    "pct_3d": 0.5950694247662147,
    "pct_7d": 1.9529006318207864,
    "quote_volume_24h": 43882735.04749,
    "trades_24h": 84838,
    "high_low_range_24h": 1.1305822498586693,
    "rsi_1h": 44.77611940298477,
    "rsi_4h": 52.027027027026996,
    "ema20_4h": 0.35514508723176635,
    "ema50_4h": 0.35267021646519947,
    "ema20_1d": 0.34688643520509255,
    "ema50_1d": 0.3330239075020719,
    "atr_4h": 0.0021214285714285636,
    "macd_hist_4h": -0.00021504536346239242,
    "volume_ratio_24h": 1.162942382405681,
    "support_level": 0.3528,
    "recent_low_4h_18": 0.3528,
    "recent_high_4h_36": 0.3584,
    "distance_to_support_pct": 0.6235827664399007,
  ...
  },
  {
    ...
    "base_asset": "TON",
    "price": 1.977,
    "score": 33.91495384181379,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 1.9698299834288646,
    "entry_high": 1.9829309999999998,
    "stop_loss": 1.831115,
    "take_profit_1": 2.266911475143296,
    "take_profit_2": 2.412176966857728,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 1.334,
    "pct_3d": 1.9072164948453763,
    "pct_7d": -15.368150684931503,
    "quote_volume_24h": 40098668.29038,
    "trades_24h": 322312,
    "high_low_range_24h": 8.957569408067044,
    "rsi_1h": 42.857142857142875,
    "rsi_4h": 53.6997885835095,
    "ema20_4h": 1.9863740086107293,
    "ema50_4h": 2.0362227573644063,
    "ema20_1d": 1.9658981870547552,
    "ema50_1d": 1.7215248193960933,
    "atr_4h": 0.07864285714285721,
    "macd_hist_4h": 0.01830061220200785,
    "volume_ratio_24h": 0.9601734480560102,
    "support_level": 1.9658981870547552,
    "recent_low_4h_18": 1.859,
    "recent_high_4h_36": 2.175,
    "distance_to_support_pct": 0.5647196288367962,
