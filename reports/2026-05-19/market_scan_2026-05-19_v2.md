---
created: 2026-05-19 23:14:11 CST
tags:
  - crypto
  - trading-system
  - market-scan
scan_id: a0af416b7052
---

# Crypto 市场扫描报告 a0af416b7052

- 报告时间：2026-05-19 23:14:11 CST
...
|---:|---|---|---:|---:|---:|---|---:|---|
| 1 | `NEAR` | 回踩支撑/4h EMA 附近 | 1.5679 - 1.5997 | 1.4470 | 1.8574 | 1.9942 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 2 | `ZEC` | 回踩支撑/4h EMA 附近 | 542.73 - 555.56 | 489.02 | 669.39 | 729.51 或跌破 4h 关键支撑 | 2.00-3.00 | 可考虑 |
| 3 | `ONDO` | 回踩支撑/4h EMA 附近 | 0.35394 - 0.36309 | 0.32820 | 0.41914 | 0.44945 或跌破 4h 关键支撑 | 2.00-3.00 | 只观察 |
| 4 | `TRX` | 回踩支撑/4h EMA 附近 | 0.35351 - 0.35433 | 0.34751 | 0.36673 | 0.38140 或跌破 4h 关键支撑 | 2.00-4.29 | 只观察 |
| 5 | `TON` | 回踩支撑/4h EMA 附近 | 1.9692 - 1.9769 | 1.8311 | 2.2569 | 2.3988 或跌破 4h 关键支撑 | 2.00-3.00 | 只观察 |

## 候选币说明

### 1. NEAR `NEARUSDT`

![NEARUSDT evidence chart](charts/a0af416b7052_NEARUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +7.93%，7d +5.34%，4h RSI 61.13，24h 成交额 $31.0M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 1.6190 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +7.93% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +5.34% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.5647 | 判断短期趋势支撑 |
| 4h EMA50 | 1.5435 | 判断中期趋势支撑 |
| 1d EMA20 | 1.5047 | 判断日线趋势 |
| 1d EMA50 | 1.4111 | 判断日线趋势 |
| 4h RSI14 | 61.13 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.5647`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.5679 - 1.5997`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.4470`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `1.8574`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `1.9942`。
...
| 2026-05-19T12:00+00:00 | 1.5980 | 1.6370 | 1.5950 | 1.6190 | $4.3M | 21980 |

### 2. ZEC `ZECUSDT`

![ZECUSDT evidence chart](charts/a0af416b7052_ZECUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +5.94%，7d +1.70%，4h RSI 65.75，24h 成交额 $138.9M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 557.63 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +5.94% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +1.70% | 判断短线趋势是否延续 |
| 4h EMA20 | 541.64 | 判断短期趋势支撑 |
| 4h EMA50 | 534.16 | 判断中期趋势支撑 |
| 1d EMA20 | 508.35 | 判断日线趋势 |
| 1d EMA50 | 424.35 | 判断日线趋势 |
| 4h RSI14 | 65.75 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `541.64`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `542.73 - 555.56`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `489.02`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `669.39`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `729.51`。
...
| 2026-05-19T12:00+00:00 | 554.43 | 568.55 | 551.00 | 557.63 | $17.3M | 70349 |

### 3. ONDO `ONDOUSDT`

![ONDOUSDT evidence chart](charts/a0af416b7052_ONDOUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +5.72%，7d -7.30%，4h RSI 51.74，24h 成交额 $34.0M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.36200 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +5.72% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | -7.30% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.36321 | 判断短期趋势支撑 |
| 4h EMA50 | 0.36730 | 判断中期趋势支撑 |
| 1d EMA20 | 0.35324 | 判断日线趋势 |
| 1d EMA50 | 0.31621 | 判断日线趋势 |
| 4h RSI14 | 51.74 | 判断是否过热/过弱 |
| 4h ATR14 | 0.01502 | 推导止损和入场缓冲 |
| 最近 18 根 4h 最低点 | 0.33320 | 支撑/止损参考 |
| 最近 36 根 4h 最高点 | 0.41570 | TP/压力参考 |
| 支撑位 | 0.35324 | 入场区间推导基础 |

#### 交易计划推导

- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `0.35324`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `0.35394 - 0.36309`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `0.32820`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `0.41914`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `0.44945`。
...
| 2026-05-19T12:00+00:00 | 0.36730 | 0.37250 | 0.35910 | 0.36200 | $5.3M | 41321 |

### 4. TRX `TRXUSDT`

![TRXUSDT evidence chart](charts/a0af416b7052_TRXUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h -0.14%，7d +2.04%，4h RSI 50.66，24h 成交额 $42.1M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 0.35460 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | -0.14% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | +2.04% | 判断短线趋势是否延续 |
| 4h EMA20 | 0.35511 | 判断短期趋势支撑 |
| 4h EMA50 | 0.35265 | 判断中期趋势支撑 |
| 1d EMA20 | 0.34685 | 判断日线趋势 |
...
| 2026-05-19T12:00+00:00 | 0.35520 | 0.35680 | 0.35410 | 0.35460 | $6.7M | 15761 |

### 5. TON `TONUSDT`

![TONUSDT evidence chart](charts/a0af416b7052_TONUSDT.svg)

- 入选原因：回踩支撑/4h EMA 附近；24h +2.07%，7d -14.45%，4h RSI 52.92，24h 成交额 $37.8M。
...
| 指标 | 数值 | 人工核对用途 |
|---|---:|---|
| 当前价 | 1.9710 | 与 Binance/TradingView 当前价格对照 |
| 24h 涨跌 | +2.07% | 与交易所 24h 涨跌对照 |
| 7d 涨跌 | -14.45% | 判断短线趋势是否延续 |
| 4h EMA20 | 1.9857 | 判断短期趋势支撑 |
| 4h EMA50 | 2.0359 | 判断中期趋势支撑 |
| 1d EMA20 | 1.9652 | 判断日线趋势 |
| 1d EMA50 | 1.7213 | 判断日线趋势 |
| 4h RSI14 | 52.92 | 判断是否过热/过弱 |
...
- 支撑位 = 最近低点、4h EMA20、4h EMA50、1d EMA20 中不高于当前价的最高有效支撑 = `1.9652`。
- 入场区间 = 支撑位附近 + ATR 缓冲 = `1.9692 - 1.9769`。
- 止损 = min(最近 18 根 4h 最低点 * 0.985, 入场中位价 - 1.15 * ATR14) = `1.8311`。
- TP1 = max(最近 36 根 4h 最高点 * 0.995, 入场中位价 + 2R) = `2.2569`。
- TP2 = max(入场中位价 + 3R, TP1 * 1.04) = `2.3988`。
...
| 2026-05-19T12:00+00:00 | 1.9840 | 2.0210 | 1.9550 | 1.9710 | $5.1M | 43201 |
...
[
  {
    ...
    "base_asset": "NEAR",
    "price": 1.619,
    "score": 69.76443263029813,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 1.5678590729580566,
    "entry_high": 1.5996796137305955,
    "stop_loss": 1.446965,
    "take_profit_1": 1.857378030032978,
    "take_profit_2": 1.994182373377304,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 7.933,
    "pct_3d": 8.512064343163539,
    "pct_7d": 5.335068314899161,
    "quote_volume_24h": 31049285.1695,
    "trades_24h": 173170,
    "high_low_range_24h": 11.505016722408023,
    "rsi_1h": 51.4285714285714,
    "rsi_4h": 61.125319693094646,
    "ema20_4h": 1.5647296137305955,
    "ema50_4h": 1.5434969873924016,
    "ema20_1d": 1.5047285103056374,
    "ema50_1d": 1.411126490820574,
    "atr_4h": 0.049928571428571385,
    "macd_hist_4h": 0.01335053168772481,
    "volume_ratio_24h": 1.1949733694443758,
    "support_level": 1.5647296137305955,
    "recent_low_4h_18": 1.469,
    "recent_high_4h_36": 1.667,
    "distance_to_support_pct": 3.4683555416334277,
  ...
  },
  {
    ...
    "base_asset": "ZEC",
    "price": 557.63,
    "score": 68.80688526283143,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "可考虑",
    "entry_low": 542.728225635291,
    "entry_high": 555.5599357637634,
    "stop_loss": 489.02295000000004,
    "take_profit_1": 669.3863420985815,
    "take_profit_2": 729.5074727981087,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 5.941,
    "pct_3d": 10.66722235452886,
    "pct_7d": 1.6960589426075368,
    "quote_volume_24h": 138932284.65232,
    "trades_24h": 496332,
    "high_low_range_24h": 10.045200541643617,
    "rsi_1h": 41.23912657553698,
    "rsi_4h": 65.75294934073561,
    "ema20_4h": 541.6449357637634,
    "ema50_4h": 534.1560441201183,
    "ema20_1d": 508.3539012130491,
    "ema50_1d": 424.35255742148246,
    "atr_4h": 19.878571428571416,
    "macd_hist_4h": 4.880132774083026,
    "volume_ratio_24h": 1.2276140971861775,
    "support_level": 541.6449357637634,
    "recent_low_4h_18": 496.47,
    "recent_high_4h_36": 577.0,
    "distance_to_support_pct": 2.95120718034525,
  ...
  },
  {
    ...
    "base_asset": "ONDO",
    "price": 0.362,
    "score": 44.62075776488546,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 0.3539443338525872,
    "entry_high": 0.36308599999999996,
    "stop_loss": 0.328202,
    "take_profit_1": 0.4191415007788808,
    "take_profit_2": 0.4494546677051744,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 5.724,
    "pct_3d": 4.112740868564857,
    "pct_7d": -7.29833546734956,
    "quote_volume_24h": 33973643.95065,
    "trades_24h": 268986,
    "high_low_range_24h": 18.383658969804607,
    "rsi_1h": 37.13136729222518,
    "rsi_4h": 51.736111111111114,
    "ema20_4h": 0.36320797914623504,
    "ema50_4h": 0.3672997043024233,
    "ema20_1d": 0.3532378581363146,
    "ema50_1d": 0.3162109489750852,
    "atr_4h": 0.015021428571428571,
    "macd_hist_4h": 0.004273857981126049,
    "volume_ratio_24h": 2.4262823419331494,
    "support_level": 0.3532378581363146,
    "recent_low_4h_18": 0.3332,
    "recent_high_4h_36": 0.4157,
    "distance_to_support_pct": 2.480521739633046,
  ...
  },
  {
    ...
    "pct_24h": -0.141,
    "pct_3d": 0.028208744710878086,
    "pct_7d": 2.043165467625907,
    "quote_volume_24h": 42096707.49992,
    "trades_24h": 82955,
    "high_low_range_24h": 1.1305822498586693,
    "rsi_1h": 41.42857142857145,
    "rsi_4h": 50.657894736842216,
    "ema20_4h": 0.35510699199367113,
    "ema50_4h": 0.35265453019068965,
    "ema20_1d": 0.3468483399669973,
    "ema50_1d": 0.3330082212275621,
    "atr_4h": 0.0021785714285714186,
    "macd_hist_4h": -0.0002405724289894235,
    "volume_ratio_24h": 1.030729929690446,
    "support_level": 0.3528,
    "recent_low_4h_18": 0.3528,
    "recent_high_4h_36": 0.3584,
    "distance_to_support_pct": 0.5102040816326703,
  ...
  },
  {
    ...
    "base_asset": "TON",
    "price": 1.971,
    "score": 34.560357048006246,
    "setup": "回踩支撑/4h EMA 附近",
    "verdict": "只观察",
    "entry_low": 1.9691619834288647,
    "entry_high": 1.976913,
    "stop_loss": 1.831115,
    "take_profit_1": 2.256882475143297,
    "take_profit_2": 2.3988049668577296,
    "risk_reward_1": 2.0,
    "risk_reward_2": 3.0,
    "pct_24h": 2.073,
    "pct_3d": 1.3367609254498758,
    "pct_7d": -14.45312499999999,
    "quote_volume_24h": 37767313.675,
    "trades_24h": 310850,
    "high_low_range_24h": 8.957569408067044,
    "rsi_1h": 48.837209302325576,
    "rsi_4h": 52.91666666666667,
    "ema20_4h": 1.9857073419440627,
    "ema50_4h": 2.035948247560485,
    "ema20_1d": 1.9652315203880886,
    "ema50_1d": 1.7212503095921716,
    "atr_4h": 0.07985714285714292,
    "macd_hist_4h": 0.017853888555284338,
    "volume_ratio_24h": 0.9091536410659239,
    "support_level": 1.9652315203880886,
    "recent_low_4h_18": 1.859,
    "recent_high_4h_36": 2.175,
    "distance_to_support_pct": 0.2935267194764002,
