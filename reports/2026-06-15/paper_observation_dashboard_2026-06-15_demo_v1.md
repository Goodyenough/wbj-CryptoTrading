---
created: 2026-06-15 20:06:37 CST
tags:
  - crypto
  - trading-system
  - paper-observation
...
|---|---|---:|
| `ONDOUSDT` | ENTERED | 644.9 |
| `ONDOUSDT` | ENTERED | 644.7 |
| `WLDUSDT` | ENTERED | 104.5 |

## 今日扫描 Action 与 RISK_OFF

| Scope | BUY_CANDIDATE | WAIT_PULLBACK | WATCH_ONLY | REJECT | Other |
|---|---:|---:|---:|---:|---:|
| All candidates | 0 | 3 | 2 | 0 | 0 |
| RISK_OFF-tagged | 0 | 3 | 2 | 0 | 0 |

## RECLAIM_PENDING 明细

| Symbol | Status | Stop | Last Price | Outcome | Last Pending |
|---|---|---:|---:|---|---|
| `ONDOUSDT` | WATCHING | 0.338446 | 0.3807 | still_waiting | 2026-06-15 20:06:35 CST |
