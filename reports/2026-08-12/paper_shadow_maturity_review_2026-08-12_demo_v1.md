...
| plan-linked decision rows | 90 |
| mature terminal rows | 0 |
| right-censored open rows | 90 |
| unknown plan rows | 0 |
...
- latest_4h_run: `20260811_161003_1f7e4476` status=`success`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-11T16:10:03Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 70 |
| `reference_baseline` | 70 |
| `research_incumbent` | 70 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 90 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:90` | `capacity_available:90` | `unknown:90` |
