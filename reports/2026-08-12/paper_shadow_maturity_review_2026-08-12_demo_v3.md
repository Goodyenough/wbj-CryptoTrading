...
| plan-linked decision rows | 96 |
| mature terminal rows | 0 |
| right-censored open rows | 96 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 96 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:96` | `capacity_available:96` | `unknown:96` |
...
| `decision_level_unknown` | 96 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 216 |
