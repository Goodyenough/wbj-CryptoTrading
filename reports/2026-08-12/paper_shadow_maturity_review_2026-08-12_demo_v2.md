...
| plan-linked decision rows | 93 |
| mature terminal rows | 0 |
| right-censored open rows | 93 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 93 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:93` | `capacity_available:93` | `unknown:93` |
...
| `decision_level_unknown` | 93 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 213 |
