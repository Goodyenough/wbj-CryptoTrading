...
- 最终权益：10,533.70 USDT
- 净收益：5.34%
- 代码 commit：`5dea3dd2d3bc78a3aa09f171673a2a52a2468557`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
| Open trades（仍开放持仓） | 3 |
| Win rate（胜率） | 31.37% |
| Profit factor（盈利因子） | 1.14 |
| Avg R（平均R倍数） | 0.13 |
| Net return（净收益率） | 5.34% |
| Max drawdown（最大回撤） | 1,896.31 / 15.90% |
| Intrabar max drawdown（K线内最大回撤） | 1,893.60 / 15.90% |
| TP1 touched rate（第一止盈触达率） | 43.14% |
| TP2 close rate（第二止盈平仓率） | 31.37% |
| Stop rate（止损率） | 68.63% |
| Fee drag（手续费拖累） | 94.58 USDT |
| Tail max single loss（最大单笔亏损） | -127.01 USDT |
| CAGR（年化复合收益率） | 5.34% |
| Sharpe（夏普比率） | 0.37 |
| Sortino（索提诺比率） | 0.45 |
| Exposure（持仓暴露时间） | 88.08% |
| Turnover（换手率） | 8.24 |
...
| `BTCUSDT` | STOPPED（已止损） | 2025-06-06T16:00:00+00:00 | 105,460.26 | 98,767.81 | 0.02 | -101.19 | -103.32 | -1.04 | 2.13 | Stop loss hit. |
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 13.53 | -100.04 | -100.87 | -1.01 | 0.83 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.57 | -101.22 | -103.12 | -1.03 | 1.90 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 40.70 | -103.30 | -104.44 | -1.02 | 1.14 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 3.41 | 3.13 | 374.58 | -106.13 | -107.81 | -1.03 | 1.68 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-24T16:00:00+00:00 | 105,613.24 | 96,630.27 | 0.01 | -98.44 | -99.96 | -1.03 | 1.52 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.96 | 274.72 | 272.73 | 2.77 | 1.99 | TP2 hit; paper trade closed. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.25 | 1,888.56 | -98.05 | -98.74 | -1.01 | 0.69 | Stop loss hit. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 649.91 | 716.08 | 4.75 | 314.28 | 311.69 | 3.23 | 2.60 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 185.36 | -99.26 | -101.03 | -1.03 | 1.77 | Stop loss hit. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 945.36 | 259.22 | 258.48 | 2.62 | 0.74 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 74,772.35 | 256.75 | 255.73 | 2.53 | 1.03 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 39,859,475.91 | 253.83 | 253.03 | 2.44 | 0.80 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-07-13T00:00:00+00:00 | 20.71 | 24.86 | 65.87 | 273.72 | 272.52 | 2.50 | 1.20 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T08:00:00+00:00 | 1.07 | 1.31 | 1,174.59 | 273.22 | 272.10 | 2.41 | 1.12 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 200.54 | -114.71 | -115.70 | -1.01 | 0.99 | Stop loss hit. |
| `NEIROUSDT` | STOPPED（已止损） | 2025-07-17T16:00:00+00:00 | 0.00 | 0.00 | 1,470,140.20 | -116.81 | -117.79 | -1.01 | 0.97 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 32,135,685.19 | -115.29 | -116.74 | -1.02 | 1.45 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.88 | 0.79 | 1,345.94 | -119.40 | -120.93 | -1.02 | 1.53 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 0.89 | 1,436.57 | -116.07 | -117.91 | -1.03 | 1.84 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-28T20:00:00+00:00 | 824.39 | 761.33 | 1.83 | -115.47 | -117.47 | -1.03 | 2.00 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 14.23 | -111.59 | -113.90 | -1.04 | 2.30 | Stop loss hit. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 174.47 | 217.27 | 6.96 | 298.01 | 296.92 | 2.71 | 1.09 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 23.09 | 28.40 | 55.70 | 295.70 | 294.56 | 2.68 | 1.15 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-08-23T04:00:00+00:00 | 0.03 | 0.03 | 16,800.51 | -112.18 | -112.89 | -1.01 | 0.71 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-08T16:00:00+00:00 | 4,381.79 | 4,168.29 | 0.54 | -116.11 | -119.33 | -1.05 | 3.22 | Stop loss hit. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T00:00:00+00:00 | 29.85 | 34.86 | 55.72 | 279.34 | 277.90 | 2.43 | 1.44 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T08:00:00+00:00 | 930.05 | 1,025.84 | 3.48 | 333.46 | 330.73 | 2.87 | 2.72 | TP2 hit; paper trade closed. |
| `XRPUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 3.04 | 2.91 | 922.82 | -123.21 | -127.01 | -1.05 | 3.80 | Stop loss hit. |
| `CAKEUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 2.89 | 2.59 | 405.22 | -120.43 | -121.95 | -1.02 | 1.52 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-10-01T12:00:00+00:00 | 4,306.31 | 3,902.60 | 0.29 | -116.77 | -118.39 | -1.02 | 1.63 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 6.18 | -117.35 | -119.14 | -1.03 | 1.79 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 58.06 | -117.50 | -119.22 | -1.03 | 1.72 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-10-26T16:00:00+00:00 | 4,060.46 | 3,757.68 | 0.37 | -112.19 | -114.19 | -1.03 | 1.99 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-11-27T16:00:00+00:00 | 2,996.52 | 2,797.38 | 0.55 | -109.40 | -111.59 | -1.03 | 2.20 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-11-30T04:00:00+00:00 | 91,152.21 | 88,714.33 | 0.05 | -113.46 | -119.29 | -1.09 | 5.83 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-12-03T08:00:00+00:00 | 93,325.63 | 82,482.85 | 0.01 | -105.99 | -107.16 | -1.02 | 1.17 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-12-07T20:00:00+00:00 | 3,107.08 | 2,861.04 | 0.43 | -106.42 | -108.19 | -1.03 | 1.78 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-12-31T00:00:00+00:00 | 2,984.10 | 3,318.38 | 0.89 | 297.42 | 295.18 | 2.82 | 2.24 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-17T16:00:00+00:00 | 3,319.13 | 3,201.01 | 0.94 | -111.41 | -115.68 | -1.07 | 4.27 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 3.10 | -111.06 | -115.05 | -1.06 | 3.99 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 10.66 | -108.23 | -109.32 | -1.02 | 1.09 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 21,903.95 | -103.16 | -103.56 | -1.01 | 0.40 | Stop loss hit. |
| `PEPEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 340,356,246.14 | 260.31 | 259.19 | 2.48 | 1.11 | TP2 hit; paper trade closed. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 85.20 | 98.36 | 21.07 | 277.30 | 275.75 | 2.61 | 1.55 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.09 | 0.11 | 19,182.96 | 269.45 | 267.89 | 2.53 | 1.56 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | STOPPED（已止损） | 2026-05-09T04:00:00+00:00 | 0.11 | 0.10 | 16,880.13 | -115.37 | -117.87 | -1.04 | 2.50 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-11T00:00:00+00:00 | 0.00 | 0.00 | 344,163,931.85 | -114.78 | -116.76 | -1.03 | 1.98 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-12T04:00:00+00:00 | 1.46 | 1.39 | 1,508.21 | -114.73 | -117.71 | -1.05 | 2.98 | Stop loss hit. |

## 回测结束仍开放

| Symbol（交易对） | Status（状态） | Entry（入场价） | Qty（数量） | Unrealized Handling（未实现盈亏处理） | Notes（备注） |
|---|---|---:|---:|---|---|
| `ETHUSDT` | TP1_HIT（第一止盈已触达） | 1,990.26 | 0.56 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BTCUSDT` | TP1_HIT（第一止盈已触达） | 69,208.02 | 0.01 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 2,063.24 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T18:21:43+00:00",
