...
- 最终权益：8,509.52 USDT
- 净收益：-14.90%
- 代码 commit：`283a1a12315afd104737c21d983ca368f7a1c9c8`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
|---|---:|
| Trades（计划总数） | 272 |
| Closed trades（已结束交易） | 48 |
| Open trades（仍开放持仓） | 4 |
| Win rate（胜率） | 16.67% |
| Profit factor（盈利因子） | 0.55 |
| Avg R（平均R倍数） | -0.33 |
| Net return（净收益率） | -14.90% |
| Max drawdown（最大回撤） | 2,000.05 / 19.43% |
| Intrabar max drawdown（K线内最大回撤） | 1,981.47 / 19.39% |
| TP1 touched rate（第一止盈触达率） | 29.17% |
| TP2 close rate（第二止盈平仓率） | 16.67% |
| Stop rate（止损率） | 83.33% |
| Fee drag（手续费拖累） | 61.27 USDT |
...
| `AAVEUSDT` | STOPPED（已止损） | 2025-05-24T20:00:00+00:00 | 264.90 | 264.63 | 3.14 | -0.83 | -1.99 | -0.02 | 1.16 | Stop loss hit. |
...
| `BCHUSDT` | STOPPED（已止损） | 2025-06-12T20:00:00+00:00 | 433.21 | 411.12 | 4.12 | -91.12 | -93.53 | -1.05 | 2.41 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-16T08:00:00+00:00 | 2,619.50 | 2,448.94 | 0.52 | -88.12 | -89.93 | -1.04 | 1.81 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.84 | 238.94 | 237.21 | 2.77 | 1.73 | TP2 hit; paper trade closed. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.30 | 1,638.11 | -0.49 | -1.17 | -0.01 | 0.68 | Stop loss hit. |
| `SUIUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2.91 | 3.97 | 231.57 | 245.06 | 244.42 | 2.87 | 0.64 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 825.77 | 226.43 | 225.78 | 2.62 | 0.65 | TP2 hit; paper trade closed. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-11T00:00:00+00:00 | 512.91 | 486.01 | 3.46 | -93.05 | -95.44 | -1.04 | 2.39 | Stop loss hit. |
| `ADAUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T12:00:00+00:00 | 0.74 | 0.88 | 1,533.68 | 225.08 | 224.09 | 2.45 | 1.00 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.32 | 953.35 | 230.53 | 229.62 | 2.46 | 0.91 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 167.75 | -95.95 | -96.78 | -1.01 | 0.83 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 26,835,447.87 | -96.27 | -97.48 | -1.02 | 1.21 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 19.38 | 17.25 | 46.44 | -98.81 | -99.97 | -1.02 | 1.16 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.35 | -94.45 | -96.21 | -1.03 | 1.75 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-07-28T00:00:00+00:00 | 0.04 | 0.04 | 11,764.56 | -95.16 | -95.78 | -1.01 | 0.61 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 2,990.77 | -93.35 | -94.13 | -1.01 | 0.78 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,064.29 | -91.37 | -92.19 | -1.02 | 0.82 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 121.07 | 11.79 | -1.43 | -3.43 | -0.04 | 2.00 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 0.34 | 0.34 | 7,187.61 | -2.43 | -5.82 | -0.06 | 3.39 | Stop loss hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-08-14T08:00:00+00:00 | 0.83 | 0.71 | 781.79 | -91.76 | -92.57 | -1.01 | 0.81 | Stop loss hit. |
| `ETHFIUSDT` | STOPPED（已止损） | 2025-08-14T12:00:00+00:00 | 1.30 | 1.13 | 520.20 | -91.43 | -92.28 | -1.02 | 0.86 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-08-15T08:00:00+00:00 | 25.10 | 22.40 | 32.98 | -89.15 | -90.22 | -1.02 | 1.07 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 572.84 | -89.89 | -90.55 | -1.01 | 0.66 | Stop loss hit. |
...
| `ARKUSDT` | ENTERED（已入场） | 0.46 | 1,076.03 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BERAUSDT` | TP1_HIT（第一止盈已触达） | 2.15 | 303.57 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ETHUSDT` | ENTERED（已入场） | 4,612.80 | 0.24 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T20:04:28+00:00",
