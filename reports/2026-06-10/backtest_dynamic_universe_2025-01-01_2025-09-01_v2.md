...
- 最终权益：9,650.44 USDT
- 净收益：-3.50%
- 代码 commit：`2405e4085fc0d4c9544d9e7b1755029160963c23`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
| Avg R（平均R倍数） | -0.04 |
| Net return（净收益率） | -3.50% |
| Max drawdown（最大回撤） | 1,804.95 / 17.63% |
| Intrabar max drawdown（K线内最大回撤） | 1,792.67 / 17.68% |
| TP1 touched rate（第一止盈触达率） | 39.02% |
| TP2 close rate（第二止盈平仓率） | 26.83% |
| Stop rate（止损率） | 73.17% |
| Fee drag（手续费拖累） | 57.11 USDT |
| Tail max single loss（最大单笔亏损） | -107.34 USDT |
| CAGR（年化复合收益率） | -5.20% |
| Sharpe（夏普比率） | -0.17 |
| Sortino（索提诺比率） | -0.20 |
| Exposure（持仓暴露时间） | 83.13% |
| Turnover（换手率） | 5.03 |
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| `ETHUSDT` | STOPPED（已止损） | 2025-01-02T12:00:00+00:00 | 3,483.33 | 3,252.17 | 0.44 | -102.27 | -104.33 | -1.03 | 2.06 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-01-02T12:00:00+00:00 | 97,071.70 | 90,067.34 | 0.01 | -102.02 | -103.90 | -1.03 | 1.88 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 0.00 | 0.00 | 47,924,007.97 | -102.72 | -104.02 | -1.02 | 1.30 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 23.17 | 19.36 | 26.57 | -101.48 | -102.24 | -1.01 | 0.76 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 340.44 | 301.35 | 2.61 | -101.91 | -103.05 | -1.02 | 1.14 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-01-14T20:00:00+00:00 | 96,875.83 | 87,829.92 | 0.01 | -96.28 | -97.62 | -1.02 | 1.35 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-01-16T08:00:00+00:00 | 3,396.15 | 2,873.32 | 0.18 | -96.23 | -97.01 | -1.01 | 0.78 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-02-20T08:00:00+00:00 | 2,739.78 | 2,563.79 | 0.55 | -96.03 | -98.03 | -1.04 | 2.00 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-03-06T08:00:00+00:00 | 90,332.96 | 80,197.22 | 0.01 | -93.05 | -94.12 | -1.02 | 1.07 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-03-20T04:00:00+00:00 | 1,991.87 | 1,842.38 | 0.62 | -92.72 | -94.36 | -1.03 | 1.64 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-03-23T08:00:00+00:00 | 84,574.93 | 81,845.69 | 0.03 | -95.39 | -99.44 | -1.07 | 4.04 | Stop loss hit. |
| `BTCUSDT` | CLOSED（已按TP2平仓） | 2025-04-12T08:00:00+00:00 | 83,637.41 | 108,712.75 | 0.01 | 248.71 | 247.94 | 2.77 | 0.76 | TP2 hit; paper trade closed. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-04-25T20:00:00+00:00 | 1,781.57 | 2,078.51 | 0.79 | 233.82 | 232.60 | 2.56 | 1.22 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-05-11T04:00:00+00:00 | 3.98 | 3.52 | 201.66 | -94.54 | -95.57 | -1.02 | 1.03 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2025-05-11T04:00:00+00:00 | 2.38 | 2.13 | 385.70 | -94.76 | -95.95 | -1.02 | 1.19 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-05-11T12:00:00+00:00 | 3.38 | 3.06 | 295.51 | -94.55 | -95.85 | -1.02 | 1.30 | Stop loss hit. |
| `SHIBUSDT` | STOPPED（已止损） | 2025-05-11T16:00:00+00:00 | 0.00 | 0.00 | 43,992,124.62 | -94.30 | -95.18 | -1.02 | 0.88 | Stop loss hit. |
| `PEOPLEUSDT` | STOPPED（已止损） | 2025-05-20T04:00:00+00:00 | 0.03 | 0.02 | 23,219.13 | -93.27 | -94.00 | -1.01 | 0.73 | Stop loss hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-05-22T20:00:00+00:00 | 6.40 | 8.44 | 118.46 | 241.19 | 240.48 | 2.55 | 0.70 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-02T16:00:00+00:00 | 2,553.30 | 2,429.10 | 0.74 | -91.85 | -94.40 | -1.05 | 2.55 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-06T16:00:00+00:00 | 105,460.26 | 98,767.81 | 0.01 | -90.05 | -91.94 | -1.04 | 1.90 | Stop loss hit. |
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 12.03 | -88.99 | -89.72 | -1.01 | 0.74 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.50 | -90.04 | -91.73 | -1.03 | 1.69 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 36.07 | -91.54 | -92.55 | -1.02 | 1.01 | Stop loss hit. |
| `FETUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 0.79 | 0.72 | 1,288.59 | -93.36 | -94.69 | -1.02 | 1.34 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.85 | 243.83 | 242.06 | 2.77 | 1.77 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 649.91 | 716.08 | 4.22 | 278.95 | 276.64 | 3.23 | 2.30 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 164.52 | -88.10 | -89.67 | -1.03 | 1.57 | Stop loss hit. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 839.07 | 230.07 | 229.41 | 2.62 | 0.66 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 66,365.27 | 227.88 | 226.97 | 2.53 | 0.91 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 35,377,847.96 | 225.29 | 224.58 | 2.44 | 0.71 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-07-13T00:00:00+00:00 | 20.71 | 24.86 | 58.47 | 242.94 | 241.88 | 2.50 | 1.07 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T08:00:00+00:00 | 1.07 | 1.31 | 1,042.53 | 242.50 | 241.51 | 2.41 | 0.99 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 177.99 | -101.81 | -102.69 | -1.01 | 0.88 | Stop loss hit. |
| `NEIROUSDT` | STOPPED（已止损） | 2025-07-17T16:00:00+00:00 | 0.00 | 0.00 | 1,304,843.96 | -103.68 | -104.54 | -1.01 | 0.86 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 28,522,487.03 | -102.32 | -103.61 | -1.02 | 1.29 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.88 | 0.79 | 1,194.61 | -105.97 | -107.34 | -1.02 | 1.36 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 0.89 | 1,275.05 | -103.02 | -104.65 | -1.03 | 1.63 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-28T20:00:00+00:00 | 824.39 | 761.33 | 1.63 | -102.49 | -104.26 | -1.03 | 1.77 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 12.63 | -99.05 | -101.09 | -1.04 | 2.04 | Stop loss hit. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 174.47 | 217.27 | 6.18 | 264.50 | 263.53 | 2.71 | 0.97 | TP2 hit; paper trade closed. |
...
| `SEIUSDT` | TP1_HIT（第一止盈已触达） | 0.30 | 1,676.22 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `AVAXUSDT` | TP1_HIT（第一止盈已触达） | 23.09 | 49.44 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `PENGUUSDT` | ENTERED（已入场） | 0.03 | 14,911.53 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `AAVEUSDT` | EXPIRED（观察计划过期） | 2025-05-23T04:00:00+00:00 | 253.23 - 258.16 | 63.51 | Backtest WATCHING plan expired before entry. |
...
| `AAVEUSDT` | EXPIRED（观察计划过期） | 2025-05-26T08:00:00+00:00 | 263.93 - 269.55 | 72.66 | Backtest WATCHING plan expired before entry. |
...
| `ENAUSDT` | INVALIDATED（未入场前失效） | 2025-05-28T08:00:00+00:00 | 0.39 - 0.40 | 65.48 | Plan invalidated before entry: current price is below stop loss. |
...
| `SUIUSDT` | INVALIDATED（未入场前失效） | 2025-06-10T04:00:00+00:00 | 3.38 - 3.41 | 67.41 | Plan invalidated before entry: current price is below stop loss. |
...
| `DOGEUSDT` | INVALIDATED（未入场前失效） | 2025-06-11T12:00:00+00:00 | 0.20 - 0.20 | 67.39 | Plan invalidated before entry: current price is below stop loss. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T16:47:17+00:00",
