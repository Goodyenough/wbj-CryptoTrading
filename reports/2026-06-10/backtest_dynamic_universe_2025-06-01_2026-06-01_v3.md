...
- 最终权益：10,596.42 USDT
- 净收益：5.96%
- 代码 commit：`71297066342a44169284ca3a14c9982a8249d8ee`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
| Avg R（平均R倍数） | 0.17 |
| Net return（净收益率） | 5.96% |
| Max drawdown（最大回撤） | 1,728.09 / 14.46% |
| Intrabar max drawdown（K线内最大回撤） | 1,744.55 / 14.62% |
| TP1 touched rate（第一止盈触达率） | 41.30% |
| TP2 close rate（第二止盈平仓率） | 32.61% |
| Stop rate（止损率） | 67.39% |
| Fee drag（手续费拖累） | 78.40 USDT |
| Tail max single loss（最大单笔亏损） | -127.20 USDT |
| CAGR（年化复合收益率） | 5.96% |
| Sharpe（夏普比率） | 0.41 |
| Sortino（索提诺比率） | 0.43 |
| Exposure（持仓暴露时间） | 62.69% |
| Turnover（换手率） | 6.91 |
...
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.57 | -101.15 | -103.05 | -1.03 | 1.90 | Stop loss hit. |
...
| `BTCUSDT` | STOPPED（已止损） | 2025-06-24T16:00:00+00:00 | 105,613.24 | 96,630.27 | 0.01 | -98.44 | -99.96 | -1.03 | 1.52 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.96 | 274.73 | 272.74 | 2.77 | 1.99 | TP2 hit; paper trade closed. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.25 | 1,888.66 | -98.05 | -98.74 | -1.01 | 0.69 | Stop loss hit. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 649.91 | 716.08 | 4.75 | 314.30 | 311.70 | 3.23 | 2.60 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 185.37 | -99.27 | -101.04 | -1.03 | 1.77 | Stop loss hit. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 945.41 | 259.23 | 258.49 | 2.62 | 0.74 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 74,776.35 | 256.77 | 255.74 | 2.53 | 1.03 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 39,861,610.26 | 253.85 | 253.04 | 2.44 | 0.80 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-07-13T00:00:00+00:00 | 20.71 | 24.86 | 65.88 | 273.73 | 272.53 | 2.50 | 1.20 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T08:00:00+00:00 | 1.07 | 1.31 | 1,174.65 | 273.24 | 272.12 | 2.41 | 1.12 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 200.55 | -114.71 | -115.71 | -1.01 | 0.99 | Stop loss hit. |
| `NEIROUSDT` | STOPPED（已止损） | 2025-07-17T16:00:00+00:00 | 0.00 | 0.00 | 1,470,218.92 | -116.82 | -117.79 | -1.01 | 0.97 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 32,137,405.95 | -115.29 | -116.74 | -1.02 | 1.45 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.88 | 0.79 | 1,346.01 | -119.41 | -120.94 | -1.02 | 1.53 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 0.89 | 1,436.64 | -116.07 | -117.91 | -1.03 | 1.84 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-28T20:00:00+00:00 | 824.39 | 761.33 | 1.83 | -115.48 | -117.47 | -1.03 | 2.00 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 14.23 | -111.60 | -113.90 | -1.04 | 2.30 | Stop loss hit. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 174.47 | 217.27 | 6.96 | 298.03 | 296.93 | 2.71 | 1.09 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 23.09 | 28.40 | 55.71 | 295.72 | 294.57 | 2.68 | 1.15 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-08-23T04:00:00+00:00 | 0.03 | 0.03 | 16,801.41 | -112.19 | -112.89 | -1.01 | 0.71 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-11T04:00:00+00:00 | 4,385.13 | 4,208.40 | 0.66 | -116.93 | -120.88 | -1.06 | 3.94 | Stop loss hit. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T00:00:00+00:00 | 29.85 | 34.86 | 55.78 | 279.67 | 278.23 | 2.43 | 1.44 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T08:00:00+00:00 | 930.05 | 1,025.84 | 3.48 | 333.70 | 330.98 | 2.87 | 2.73 | TP2 hit; paper trade closed. |
| `XRPUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 3.04 | 2.91 | 924.16 | -123.39 | -127.20 | -1.05 | 3.81 | Stop loss hit. |
| `CAKEUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 2.89 | 2.59 | 405.58 | -120.54 | -122.06 | -1.02 | 1.52 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 6.17 | -117.14 | -118.92 | -1.03 | 1.78 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 57.95 | -117.30 | -119.01 | -1.03 | 1.72 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.03 | 0.03 | 21,482.26 | -116.33 | -117.16 | -1.01 | 0.83 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.45 | -110.32 | -112.31 | -1.03 | 1.98 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 3.14 | -112.57 | -116.61 | -1.06 | 4.04 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 10.80 | -109.66 | -110.76 | -1.02 | 1.11 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 22,346.83 | -105.24 | -105.65 | -1.01 | 0.41 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-16T00:00:00+00:00 | 2,346.05 | 2,140.90 | 0.53 | -108.71 | -110.34 | -1.03 | 1.63 | Stop loss hit. |
| `PEPEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 339,683,924.59 | 259.79 | 258.68 | 2.48 | 1.11 | TP2 hit; paper trade closed. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 85.20 | 98.36 | 21.03 | 276.75 | 275.21 | 2.61 | 1.54 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.09 | 0.11 | 19,145.07 | 268.92 | 267.36 | 2.53 | 1.56 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | STOPPED（已止损） | 2026-05-09T04:00:00+00:00 | 0.11 | 0.10 | 16,936.99 | -115.75 | -118.27 | -1.04 | 2.51 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-11T00:00:00+00:00 | 0.00 | 0.00 | 345,451,628.17 | -115.21 | -117.20 | -1.03 | 1.99 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-12T04:00:00+00:00 | 1.46 | 1.39 | 1,513.41 | -115.13 | -118.11 | -1.05 | 2.99 | Stop loss hit. |
...
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 2,065.74 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `FETUSDT` | EXPIRED（观察计划过期） | 2025-07-11T16:00:00+00:00 | 0.71 - 0.73 | 63.35 | Backtest WATCHING plan expired before entry. |
...
| `NEIROUSDT` | EXPIRED（观察计划过期） | 2025-07-14T08:00:00+00:00 | 0.00 - 0.00 | 66.25 | Backtest WATCHING plan expired before entry. |
...
| `XLMUSDT` | EXPIRED（观察计划过期） | 2025-07-17T08:00:00+00:00 | 0.45 - 0.46 | 74.11 | Backtest WATCHING plan expired before entry. |
...
| `TAOUSDT` | EXPIRED（观察计划过期） | 2025-07-22T20:00:00+00:00 | 430.65 - 438.51 | 65.43 | Backtest WATCHING plan expired before entry. |
...
| `HBARUSDT` | EXPIRED（观察计划过期） | 2025-08-08T16:00:00+00:00 | 0.25 - 0.26 | 65.10 | Backtest WATCHING plan expired before entry. |
...
| `APTUSDT` | INVALIDATED（未入场前失效） | 2025-10-08T00:00:00+00:00 | 5.33 - 5.33 | 59.15 | Plan invalidated before entry: current price is below stop loss. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T19:42:50+00:00",
