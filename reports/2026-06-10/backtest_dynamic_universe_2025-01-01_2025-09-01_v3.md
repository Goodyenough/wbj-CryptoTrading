...
- 最终权益：9,997.47 USDT
- 净收益：-0.03%
- 代码 commit：`9769a9ce313e1a07641528a0275b7350424e734f`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
| Avg R（平均R倍数） | 0.05 |
| Net return（净收益率） | -0.03% |
| Max drawdown（最大回撤） | 1,555.34 / 15.11% |
| Intrabar max drawdown（K线内最大回撤） | 1,537.86 / 15.10% |
| TP1 touched rate（第一止盈触达率） | 44.74% |
| TP2 close rate（第二止盈平仓率） | 28.95% |
| Stop rate（止损率） | 71.05% |
| Fee drag（手续费拖累） | 53.62 USDT |
| Tail max single loss（最大单笔亏损） | -111.20 USDT |
| CAGR（年化复合收益率） | -0.04% |
| Sharpe（夏普比率） | 0.10 |
| Sortino（索提诺比率） | 0.11 |
| Exposure（持仓暴露时间） | 72.36% |
| Turnover（换手率） | 4.85 |
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| `BTCUSDT` | STOPPED（已止损） | 2025-01-03T00:00:00+00:00 | 97,239.11 | 90,562.57 | 0.02 | -102.83 | -104.83 | -1.03 | 1.99 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-01-03T08:00:00+00:00 | 3,442.32 | 3,260.91 | 0.57 | -102.83 | -105.45 | -1.04 | 2.63 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 0.00 | 0.00 | 48,112,979.23 | -103.12 | -104.43 | -1.02 | 1.31 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 23.17 | 19.36 | 26.66 | -101.83 | -102.59 | -1.01 | 0.76 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-01-04T04:00:00+00:00 | 340.44 | 301.35 | 2.62 | -102.27 | -103.42 | -1.02 | 1.14 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-01-15T04:00:00+00:00 | 97,333.55 | 87,829.92 | 0.01 | -96.17 | -97.46 | -1.02 | 1.28 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-01-16T08:00:00+00:00 | 3,396.15 | 2,873.32 | 0.18 | -96.13 | -96.90 | -1.01 | 0.78 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-04-25T08:00:00+00:00 | 1,766.22 | 2,248.32 | 0.53 | 253.59 | 252.74 | 2.71 | 0.84 | TP2 hit; paper trade closed. |
| `BTCUSDT` | CLOSED（已按TP2平仓） | 2025-04-28T08:00:00+00:00 | 94,464.15 | 103,945.22 | 0.03 | 293.38 | 290.93 | 3.08 | 2.46 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-05-11T04:00:00+00:00 | 3.98 | 3.52 | 212.15 | -99.45 | -100.54 | -1.02 | 1.08 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2025-05-11T04:00:00+00:00 | 2.38 | 2.13 | 405.77 | -99.69 | -100.94 | -1.02 | 1.25 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-05-11T12:00:00+00:00 | 3.38 | 3.06 | 311.05 | -99.52 | -100.89 | -1.02 | 1.37 | Stop loss hit. |
| `SHIBUSDT` | STOPPED（已止损） | 2025-05-11T16:00:00+00:00 | 0.00 | 0.00 | 46,291,931.08 | -99.23 | -100.15 | -1.02 | 0.92 | Stop loss hit. |
| `FETUSDT` | STOPPED（已止损） | 2025-05-11T16:00:00+00:00 | 0.85 | 0.73 | 834.11 | -99.95 | -100.84 | -1.02 | 0.89 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-05-18T08:00:00+00:00 | 0.00 | 0.00 | 82,431,038.07 | -96.97 | -98.36 | -1.02 | 1.40 | Stop loss hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-05-22T20:00:00+00:00 | 6.40 | 8.44 | 123.84 | 252.14 | 251.40 | 2.55 | 0.74 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-02T16:00:00+00:00 | 2,553.30 | 2,429.10 | 0.77 | -95.16 | -97.80 | -1.05 | 2.64 | Stop loss hit. |
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 12.46 | -92.13 | -92.89 | -1.01 | 0.76 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 105,888.73 | 98,767.81 | 0.01 | -93.22 | -95.07 | -1.03 | 1.85 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.52 | -93.22 | -94.97 | -1.03 | 1.75 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 3.41 | 3.13 | 341.67 | -96.80 | -98.34 | -1.03 | 1.54 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-06-10T12:00:00+00:00 | 0.71 | 0.64 | 1,478.14 | -97.54 | -98.90 | -1.02 | 1.37 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.88 | 252.60 | 250.77 | 2.77 | 1.83 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 649.91 | 716.08 | 4.37 | 288.98 | 286.59 | 3.23 | 2.39 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 170.43 | -91.27 | -92.90 | -1.03 | 1.63 | Stop loss hit. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 869.24 | 238.35 | 237.66 | 2.62 | 0.68 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 68,751.75 | 236.08 | 235.13 | 2.53 | 0.94 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 36,650,026.23 | 233.39 | 232.65 | 2.44 | 0.74 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-07-13T00:00:00+00:00 | 20.71 | 24.86 | 60.57 | 251.68 | 250.58 | 2.50 | 1.10 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T08:00:00+00:00 | 1.07 | 1.31 | 1,080.01 | 251.22 | 250.19 | 2.41 | 1.03 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 184.39 | -105.47 | -106.38 | -1.01 | 0.91 | Stop loss hit. |
| `NEIROUSDT` | STOPPED（已止损） | 2025-07-17T16:00:00+00:00 | 0.00 | 0.00 | 1,351,765.81 | -107.41 | -108.30 | -1.01 | 0.89 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 29,548,148.29 | -106.00 | -107.34 | -1.02 | 1.33 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.88 | 0.79 | 1,237.56 | -109.79 | -111.20 | -1.02 | 1.41 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-23T16:00:00+00:00 | 0.97 | 0.89 | 1,320.90 | -106.72 | -108.41 | -1.03 | 1.69 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-28T20:00:00+00:00 | 824.39 | 761.33 | 1.68 | -106.17 | -108.01 | -1.03 | 1.84 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 13.09 | -102.61 | -104.73 | -1.04 | 2.12 | Stop loss hit. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T00:00:00+00:00 | 174.47 | 217.27 | 6.40 | 274.01 | 273.01 | 2.71 | 1.00 | TP2 hit; paper trade closed. |
...
| `SEIUSDT` | TP1_HIT（第一止盈已触达） | 0.30 | 1,736.50 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `AVAXUSDT` | TP1_HIT（第一止盈已触达） | 23.09 | 51.22 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `PENGUUSDT` | ENTERED（已入场） | 0.03 | 15,447.75 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `ETHUSDT` | EXPIRED（观察计划过期） | 2025-05-29T08:00:00+00:00 | 2,645.88 - 2,682.34 | 69.78 | Backtest WATCHING plan expired before entry. |
...
| `AVAXUSDT` | EXPIRED（观察计划过期） | 2025-06-10T00:00:00+00:00 | 21.48 - 21.77 | 55.42 | Backtest WATCHING plan expired before entry. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T18:59:19+00:00",
