---
created: 2026-06-10 23:04:17 CST
tags:
  - crypto
  - trading-system
  - abtest
experiment_id: risk_off_no_core_entry_reclaim
baseline_run_id: 6ecdc5df5f5b
variant_run_id: 9dd3a17c1ebf
...
|---|---:|---:|---:|
| closed_trades | 52.00 | 41.00 | -11.00 |
| stop_rate | 73.08% | 63.41% | -9.66% |
| profit_factor | 0.91 | 1.40 | 0.49 |
| avg_r | -0.03 | 0.33 | 0.36 |
| max_drawdown_pct | 18.72% | 14.31% | -4.41% |
| net_return_pct | -5.59% | 11.74% | 17.32% |
| sharpe | -0.25 | 0.79 | 1.04 |
