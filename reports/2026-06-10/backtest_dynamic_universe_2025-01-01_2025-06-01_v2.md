...
- 最终权益：9,183.16 USDT
- 净收益：-8.17%
- 代码 commit：`a120dfc272e3335d5395cccefd78a85e0e838ab5`
- 样本是否充分：false
...
| Open trades（仍开放持仓） | 1 |
| Win rate（胜率） | 13.33% |
| Profit factor（盈利因子） | 0.41 |
| Avg R（平均R倍数） | -0.50 |
| Net return（净收益率） | -8.17% |
| Max drawdown（最大回撤） | 1,117.14 / 10.85% |
| Intrabar max drawdown（K线内最大回撤） | 1,023.94 / 10.05% |
| TP1 touched rate（第一止盈触达率） | 20.00% |
| TP2 close rate（第二止盈平仓率） | 13.33% |
| Stop rate（止损率） | 86.67% |
| Fee drag（手续费拖累） | 20.43 USDT |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T19:11:42+00:00",
