...
# 回测报告 2025-01-01 至 2025-09-01 v11
...
- 最终权益：9,637.48 USDT
- 净收益：-3.63%
- 代码 commit：`6519540b66b4c4a242cff3e36876a80ded6af480`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
|---|---:|
| Trades（计划总数） | 268 |
| Closed trades（已结束交易） | 39 |
| Open trades（仍开放持仓） | 5 |
| Win rate（胜率） | 25.64% |
| Profit factor（盈利因子） | 0.84 |
| Avg R（平均R倍数） | -0.09 |
| Net return（净收益率） | -3.63% |
| Max drawdown（最大回撤） | 1,999.70 / 19.43% |
| Intrabar max drawdown（K线内最大回撤） | 1,981.13 / 19.39% |
| TP1 touched rate（第一止盈触达率） | 35.90% |
| TP2 close rate（第二止盈平仓率） | 25.64% |
| Stop rate（止损率） | 74.36% |
| Fee drag（手续费拖累） | 47.75 USDT |
| Tail max single loss（最大单笔亏损） | -105.82 USDT |
| CAGR（年化复合收益率） | -5.40% |
| Sharpe（夏普比率） | -0.20 |
| Sortino（索提诺比率） | -0.25 |
| Exposure（持仓暴露时间） | 87.72% |
| Turnover（换手率） | 4.30 |
...
| `AAVEUSDT` | STOPPED（已止损） | 2025-05-24T20:00:00+00:00 | 264.90 | 235.43 | 3.14 | -92.43 | -93.50 | -1.02 | 1.07 | Stop loss hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-05-28T16:00:00+00:00 | 6.67 | 5.86 | 112.86 | -90.84 | -91.80 | -1.02 | 0.96 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-02T16:00:00+00:00 | 2,553.30 | 2,429.10 | 0.73 | -91.12 | -93.65 | -1.05 | 2.53 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-06T16:00:00+00:00 | 105,460.26 | 98,767.81 | 0.01 | -88.84 | -90.71 | -1.04 | 1.87 | Stop loss hit. |
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 11.87 | -87.78 | -88.51 | -1.01 | 0.73 | Stop loss hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-06-08T00:00:00+00:00 | 6.37 | 8.20 | 132.06 | 242.39 | 241.62 | 2.77 | 0.77 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 35.77 | -90.78 | -91.78 | -1.02 | 1.00 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 3.41 | 3.13 | 327.47 | -92.78 | -94.25 | -1.03 | 1.47 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-16T08:00:00+00:00 | 2,619.50 | 2,448.94 | 0.53 | -89.76 | -91.60 | -1.04 | 1.84 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.84 | 238.95 | 237.22 | 2.77 | 1.73 | TP2 hit; paper trade closed. |
| `SUIUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2.91 | 3.97 | 231.58 | 245.07 | 244.43 | 2.87 | 0.64 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 825.81 | 226.44 | 225.79 | 2.62 | 0.65 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 65,402.79 | 224.58 | 223.68 | 2.53 | 0.90 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 34,985,464.11 | 222.79 | 222.09 | 2.44 | 0.71 | TP2 hit; paper trade closed. |
| `ADAUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T12:00:00+00:00 | 0.74 | 0.88 | 1,623.60 | 238.28 | 237.22 | 2.45 | 1.05 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.32 | 1,009.09 | 244.01 | 243.05 | 2.46 | 0.97 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 177.59 | -101.58 | -102.46 | -1.01 | 0.88 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 19.38 | 17.25 | 49.16 | -104.59 | -105.82 | -1.02 | 1.23 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,157.04 | -99.33 | -100.22 | -1.02 | 0.89 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 12.92 | -101.29 | -103.38 | -1.04 | 2.09 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 641.69 | -100.70 | -101.44 | -1.01 | 0.74 | Stop loss hit. |
...
| `SEIUSDT` | TP1_HIT（第一止盈已触达） | 0.30 | 1,638.18 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ARKUSDT` | ENTERED（已入场） | 0.46 | 1,121.70 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BNBUSDT` | TP1_HIT（第一止盈已触达） | 766.05 | 1.95 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ETHUSDT` | ENTERED（已入场） | 4,691.33 | 0.18 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T12:34:30+00:00",
