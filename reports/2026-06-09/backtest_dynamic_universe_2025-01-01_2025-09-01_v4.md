...
# 回测报告 2025-01-01 至 2025-09-01 v4
...
- 最终权益：8,472.91 USDT
- 净收益：-15.27%
- 代码 commit：`5787f10ae601f4f3d08867ff25c765e047c61bb0`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
|---|---:|
| Trades（计划总数） | 108 |
| Closed trades（已结束交易） | 33 |
| Open trades（仍开放持仓） | 3 |
| Win rate（胜率） | 15.15% |
| Profit factor（盈利因子） | 0.43 |
| Avg R（平均R倍数） | -0.47 |
| Net return（净收益率） | -15.27% |
| Max drawdown（最大回撤） | 2,032.33 / 19.84% |
| Intrabar max drawdown（K线内最大回撤） | 2,002.42 / 19.67% |
| TP1 touched rate（第一止盈触达率） | 27.27% |
| TP2 close rate（第二止盈平仓率） | 15.15% |
| Stop rate（止损率） | 84.85% |
| Fee drag（手续费拖累） | 48.05 USDT |
...
| `ACTUSDT` | STOPPED（已止损） | 2025-05-11T04:00:00+00:00 | 0.06 | 0.05 | 8,720.63 | -94.61 | -95.28 | -1.01 | 0.66 | Stop loss hit. |
...
| `CAKEUSDT` | STOPPED（已止损） | 2025-05-11T16:00:00+00:00 | 2.41 | 2.14 | 353.30 | -95.35 | -96.44 | -1.02 | 1.10 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-05-18T16:00:00+00:00 | 652.04 | 624.90 | 3.49 | -94.83 | -97.92 | -1.06 | 3.10 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-05-22T12:00:00+00:00 | 255.84 | 214.03 | 2.27 | -94.76 | -95.48 | -1.01 | 0.72 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-05-26T04:00:00+00:00 | 0.00 | 0.00 | 40,519,716.90 | -95.25 | -96.36 | -1.02 | 1.11 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-06T16:00:00+00:00 | 105,460.26 | 98,767.81 | 0.01 | -90.58 | -92.49 | -1.04 | 1.91 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 35.88 | -91.06 | -92.06 | -1.02 | 1.00 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 0.71 | 0.64 | 1,336.02 | -91.32 | -92.55 | -1.02 | 1.23 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-06-10T12:00:00+00:00 | 660.52 | 636.16 | 3.73 | -91.01 | -94.37 | -1.06 | 3.36 | Stop loss hit. |
| `AAVEUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T08:00:00+00:00 | 269.57 | 322.83 | 4.19 | 222.93 | 221.94 | 2.62 | 0.99 | TP2 hit; paper trade closed. |
| `ARBUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T16:00:00+00:00 | 0.34 | 0.45 | 1,902.88 | 216.16 | 215.55 | 2.53 | 0.61 | TP2 hit; paper trade closed. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-01T00:00:00+00:00 | 505.13 | 479.22 | 3.34 | -86.63 | -88.91 | -1.05 | 2.28 | Stop loss hit. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-07-03T00:00:00+00:00 | 18.57 | 23.93 | 45.34 | 242.88 | 242.11 | 2.83 | 0.77 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-08T20:00:00+00:00 | 0.00 | 0.00 | 19,086,973.02 | 229.85 | 229.42 | 2.67 | 0.43 | TP2 hit; paper trade closed. |
| `COMPUSDT` | STOPPED（已止损） | 2025-07-15T00:00:00+00:00 | 48.95 | 44.40 | 20.61 | -93.82 | -95.14 | -1.02 | 1.32 | Stop loss hit. |
| `ARBUSDT` | STOPPED（已止损） | 2025-07-17T04:00:00+00:00 | 0.43 | 0.38 | 1,974.54 | -94.08 | -95.18 | -1.02 | 1.10 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-07-18T04:00:00+00:00 | 329.07 | 301.27 | 3.48 | -96.68 | -98.18 | -1.03 | 1.51 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-21T20:00:00+00:00 | 0.87 | 0.78 | 1,043.15 | -95.13 | -96.31 | -1.02 | 1.18 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-23T08:00:00+00:00 | 776.34 | 731.66 | 2.09 | -93.47 | -95.65 | -1.04 | 2.18 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-31T08:00:00+00:00 | 0.21 | 0.18 | 2,889.53 | -89.96 | -90.72 | -1.01 | 0.76 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 576.71 | 532.94 | 2.07 | -90.39 | -91.97 | -1.03 | 1.58 | Stop loss hit. |
| `APTUSDT` | STOPPED（已止损） | 2025-08-12T16:00:00+00:00 | 4.73 | 4.41 | 281.52 | -90.65 | -92.43 | -1.03 | 1.78 | Stop loss hit. |
...
| `ARKUSDT` | ENTERED（已入场） | 0.46 | 1,052.83 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `AVAXUSDT` | TP1_HIT（第一止盈已触达） | 23.09 | 45.28 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| WARNING | `ACTUSDT` | 1d | Large wick/range candle. |
| WARNING | `ACTUSDT` | 1d | Large wick/range candle. |
| INFO | n/a | n/a | Additional issues omitted: 490. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-08T17:10:14+00:00",
