...
- 最终权益：9,464.18 USDT
- 净收益：-5.36%
- 代码 commit：`3026c07932f87ea400d37c923fe53e13300fbf48`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
|---|---:|
| Trades（计划总数） | 291 |
| Closed trades（已结束交易） | 46 |
| Open trades（仍开放持仓） | 2 |
| Win rate（胜率） | 26.09% |
| Profit factor（盈利因子） | 0.88 |
| Avg R（平均R倍数） | -0.08 |
| Net return（净收益率） | -5.36% |
| Max drawdown（最大回撤） | 2,534.80 / 21.38% |
| Intrabar max drawdown（K线内最大回撤） | 2,543.41 / 21.56% |
| TP1 touched rate（第一止盈触达率） | 30.43% |
| TP2 close rate（第二止盈平仓率） | 26.09% |
| Stop rate（止损率） | 73.91% |
| Fee drag（手续费拖累） | 78.80 USDT |
| Tail max single loss（最大单笔亏损） | -123.53 USDT |
| CAGR（年化复合收益率） | -5.36% |
| Sharpe（夏普比率） | -0.24 |
| Sortino（索提诺比率） | -0.25 |
| Exposure（持仓暴露时间） | 63.01% |
| Turnover（换手率） | 6.62 |
...
| `BTCUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 105,888.73 | 98,767.81 | 0.01 | -100.92 | -102.92 | -1.03 | 2.00 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.56 | -100.97 | -102.87 | -1.03 | 1.89 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 40.66 | -103.19 | -104.33 | -1.02 | 1.14 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 3.41 | 3.13 | 374.17 | -106.01 | -107.69 | -1.03 | 1.68 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-06-10T12:00:00+00:00 | 660.52 | 636.16 | 4.22 | -102.94 | -106.74 | -1.06 | 3.80 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-24T16:00:00+00:00 | 105,613.24 | 96,630.27 | 0.01 | -97.35 | -98.85 | -1.03 | 1.51 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.95 | 271.69 | 269.72 | 2.77 | 1.97 | TP2 hit; paper trade closed. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.25 | 1,862.61 | -96.70 | -97.38 | -1.01 | 0.68 | Stop loss hit. |
| `SUIUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2.91 | 3.97 | 263.31 | 278.64 | 277.92 | 2.87 | 0.72 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 938.94 | 257.46 | 256.72 | 2.62 | 0.74 | TP2 hit; paper trade closed. |
| `PENGUUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T00:00:00+00:00 | 0.02 | 0.02 | 74,362.98 | 255.35 | 254.33 | 2.53 | 1.02 | TP2 hit; paper trade closed. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10
| Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 0.31 | 0.30 | 6,797.91 | -103.02 | -105.89 | -1.05 | 2.87 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 10.26 | -104.21 | -105.26 | -1.02 | 1.05 | Stop loss hit. |
| `ICPUSDT` | STOPPED（已止损） | 2026-01-19T08:00:00+00:00 | 4.16 | 3.39 | 131.98 | -101.18 | -101.84 | -1.01 | 0.67 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 20,722.00 | -97.59 | -97.97 | -1.01 | 0.38 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-16T00:00:00+00:00 | 2,346.05 | 2,140.90 | 0.48 | -97.68 | -99.15 | -1.03 | 1.47 | Stop loss hit. |
| `PEPEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 313,138,173.96 | 239.49 | 238.47 | 2.48 | 1.02 | TP2 hit; paper trade closed. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 85.20 | 98.36 | 19.38 | 255.12 | 253.70 | 2.61 | 1.42 | TP2 hit; paper trade closed. |
| `AVAXUSDT` | STOPPED（已止损） | 2026-04-17T00:00:00+00:00 | 9.63 | 9.06 | 176.96 | -99.62 | -101.91 | -1.04 | 2.29 | Stop loss hit. |
| `ZECUSDT` | STOPPED（已止损） | 2026-05-10T16:00:00+00:00 | 598.44 | 540.82 | 1.79 | -102.94 | -104.34 | -1.02 | 1.39 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-11T00:00:00+00:00 | 0.00 | 0.00 | 308,278,085.12 | -102.81 | -104.59 | -1.03 | 1.77 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-12T08:00:00+00:00 | 1.47 | 1.39 | 1,287.32 | -101.85 | -104.39 | -1.04 | 2.54 | Stop loss hit. |
...
| `BOMEUSDT` | ENTERED（已入场） | 0.00 | 989,806.85 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `SOLUSDT` | INVALIDATED（未入场前失效） | 2025-06-10T04:00:00+00:00 | 159.22 - 159.65 | 55.97 | Plan invalidated before entry: current price is below stop loss. |
...
| `LTCUSDT` | INVALIDATED（未入场前失效） | 2025-06-10T12:00:00+00:00 | 90.61 - 91.42 | 64.68 | Plan invalidated before entry: current price is below stop loss. |
...
| `TRXUSDT` | EXPIRED（观察计划过期） | 2025-06-30T04:00:00+00:00 | 0.28 - 0.28 | 54.84 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2025-07-06T20:00:00+00:00 | 0.17 - 0.17 | 56.26 | Backtest WATCHING plan expired before entry. |
...
| `AAVEUSDT` | EXPIRED（观察计划过期） | 2025-07-11T04:00:00+00:00 | 296.63 - 301.12 | 72.02 | Backtest WATCHING plan expired before entry. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-07-14T08:00:00+00:00 | 690.34 - 693.47 | 66.85 | Backtest WATCHING plan expired before entry. |
...
| `HBARUSDT` | INVALIDATED（未入场前失效） | 2025-07-31T12:00:00+00:00 | 0.27 - 0.27 | 70.43 | Plan invalidated before entry: current price is below stop loss. |
...
| `SOLUSDT` | EXPIRED（观察计划过期） | 2025-08-08T04:00:00+00:00 | 172.32 - 174.38 | 51.90 | Backtest WATCHING plan expired before entry. |
...
| `CRVUSDT` | EXPIRED（观察计划过期） | 2025-08-08T08:00:00+00:00 | 0.93 - 0.94 | 52.01 | Backtest WATCHING plan expired before entry. |
...
| `SUIUSDT` | EXPIRED（观察计划过期） | 2025-08-23T08:00:00+00:00 | 3.68 - 3.75 | 60.61 | Backtest WATCHING plan expired before entry. |
...
| `LTCUSDT` | EXPIRED（观察计划过期） | 2025-09-16T20:00:00+00:00 | 115.22 - 115.54 | 54.65 | Backtest WATCHING plan expired before entry. |
| `WIFUSDT` | EXPIRED（观察计划过期） | 2025-09-16T20:00:00+00:00 | 0.91 - 0.93 | 50.68 | Backtest WATCHING plan expired before entry. |
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2025-09-17T00:00:00+00:00 | 0.27 - 0.27 | 54.01 | Backtest WATCHING plan expired before entry. |
...
| `ETHUSDT` | EXPIRED（观察计划过期） | 2025-10-02T04:00:00+00:00 | 4,272.42 - 4,311.99 | 70.11 | Backtest WATCHING plan expired before entry. |
...
| `HBARUSDT` | EXPIRED（观察计划过期） | 2025-10-02T08:00:00+00:00 | 0.22 - 0.23 | 68.43 | Backtest WATCHING plan expired before entry. |
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-10-02T08:00:00+00:00 | 1,015.56 - 1,023.33 | 66.32 | Backtest WATCHING plan expired before entry. |
...
| `NEARUSDT` | EXPIRED（观察计划过期） | 2025-10-02T12:00:00+00:00 | 2.81 - 2.85 | 52.78 | Backtest WATCHING plan expired before entry. |
| `AAVEUSDT` | EXPIRED（观察计划过期） | 2025-10-02T20:00:00+00:00 | 286.15 - 289.86 | 55.85 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | INVALIDATED（未入场前失效） | 2025-10-05T12:00:00+00:00 | 0.25 - 0.26 | 68.30 | Plan invalidated before entry: current price is below stop loss. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2026-04-16T04:00:00+00:00 | 0.09 - 0.10 | 59.64 | Backtest WATCHING plan expired before entry. |
| `BNBUSDT` | EXPIRED（观察计划过期） | 2026-04-16T04:00:00+00:00 | 615.67 - 619.52 | 56.18 | Backtest WATCHING plan expired before entry. |
| `XRPUSDT` | EXPIRED（观察计划过期） | 2026-04-16T08:00:00+00:00 | 1.37 - 1.38 | 60.70 | Backtest WATCHING plan expired before entry. |
...
| `XRPUSDT` | EXPIRED（观察计划过期） | 2026-05-09T04:00:00+00:00 | 1.41 - 1.42 | 64.34 | Backtest WATCHING plan expired before entry. |
| `BNBUSDT` | EXPIRED（观察计划过期） | 2026-05-09T04:00:00+00:00 | 643.54 - 647.53 | 63.43 | Backtest WATCHING plan expired before entry. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2026-05-12T08:00:00+00:00 | 656.79 - 660.57 | 64.62 | Backtest WATCHING plan expired before entry. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T15:43:01+00:00",
