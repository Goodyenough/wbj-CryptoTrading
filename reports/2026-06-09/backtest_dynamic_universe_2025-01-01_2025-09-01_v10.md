...
# 回测报告 2025-01-01 至 2025-09-01 v10
...
- 最终权益：9,204.14 USDT
- 净收益：-7.96%
- 代码 commit：`1e8bb33adfef33f6b59d9d0a9d3b1bdd4d13d100`
- 样本是否充分：true
- 样本提示：样本数量未触发警告。
...
|---|---:|
| Trades（计划总数） | 266 |
| Closed trades（已结束交易） | 37 |
| Open trades（仍开放持仓） | 5 |
| Win rate（胜率） | 21.62% |
| Profit factor（盈利因子） | 0.71 |
| Avg R（平均R倍数） | -0.21 |
| Net return（净收益率） | -7.96% |
| Max drawdown（最大回撤） | 1,554.82 / 15.03% |
| Intrabar max drawdown（K线内最大回撤） | 1,531.60 / 14.93% |
| TP1 touched rate（第一止盈触达率） | 29.73% |
| TP2 close rate（第二止盈平仓率） | 21.62% |
| Stop rate（止损率） | 78.38% |
| Fee drag（手续费拖累） | 50.10 USDT |
| Tail max single loss（最大单笔亏损） | -105.98 USDT |
| CAGR（年化复合收益率） | -11.71% |
| Sharpe（夏普比率） | -0.59 |
| Sortino（索提诺比率） | -0.67 |
...
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.89 | 253.31 | 251.47 | 2.77 | 1.84 | TP2 hit; paper trade closed. |
| `SUIUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2.91 | 3.97 | 245.50 | 259.79 | 259.11 | 2.87 | 0.68 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 875.42 | 240.04 | 239.35 | 2.62 | 0.69 | TP2 hit; paper trade closed. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-11T00:00:00+00:00 | 512.91 | 486.01 | 3.67 | -98.65 | -101.18 | -1.04 | 2.53 | Stop loss hit. |
| `ADAUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T12:00:00+00:00 | 0.74 | 0.88 | 1,625.90 | 238.61 | 237.56 | 2.45 | 1.06 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.32 | 1,010.67 | 244.40 | 243.43 | 2.46 | 0.97 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 177.84 | -101.72 | -102.60 | -1.01 | 0.88 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 28,448,903.79 | -102.06 | -103.34 | -1.02 | 1.28 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 19.38 | 17.25 | 49.24 | -104.75 | -105.98 | -1.02 | 1.23 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-07-28T00:00:00+00:00 | 0.04 | 0.04 | 12,471.89 | -100.88 | -101.53 | -1.01 | 0.65 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 3,178.37 | -99.21 | -100.04 | -1.01 | 0.83 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,129.66 | -96.98 | -97.85 | -1.02 | 0.87 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 12.66 | -99.28 | -101.32 | -1.04 | 2.05 | Stop loss hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-08-14T08:00:00+00:00 | 0.83 | 0.71 | 829.13 | -97.32 | -98.18 | -1.01 | 0.86 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 609.71 | -95.68 | -96.38 | -1.01 | 0.70 | Stop loss hit. |
...
| `SEIUSDT` | TP1_HIT（第一止盈已触达） | 0.30 | 1,736.60 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ARKUSDT` | ENTERED（已入场） | 0.46 | 1,140.72 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BERAUSDT` | TP1_HIT（第一止盈已触达） | 2.15 | 327.11 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `ETHUSDT` | ENTERED（已入场） | 4,616.74 | 0.25 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-09T12:02:23+00:00",
