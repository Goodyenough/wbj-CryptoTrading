...
| decisions | 105 |
| opportunities | 21 |
| candidate-only rows | 60 |
| plan-linked decision rows | 45 |
| mature terminal rows | 0 |
| right-censored open rows | 45 |
| unknown plan rows | 0 |
...
- latest_scan: `65af47840f77` at `2026-08-02T12:05:56+00:00`
- latest_daily_run: `20260802_120502_350dcb28` status=`success`
- latest_4h_run: `20260802_161002_442f70b2` status=`success`
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 45 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:45` | `capacity_available:45` | `unknown:45` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 60 |
| `decision_level_unknown` | 45 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 105 |
