...
|---|---:|
| Trades（计划总数） | 286 |
| Closed trades（已结束交易） | 61 |
| Open trades（仍开放持仓） | 1 |
| Win rate（胜率） | 36.07% |
| Profit factor（盈利因子） | 0.81 |
| Avg R（平均R倍数） | -0.13 |
| Net return（净收益率） | -7.82% |
| Max drawdown（最大回撤） | 2,326.12 / 20.47% |
| Intrabar max drawdown（K线内最大回撤） | 2,287.79 / 20.24% |
| TP1 touched rate（第一止盈触达率） | 34.43% |
| TP2 close rate（第二止盈平仓率） | 8.20% |
| Stop rate（止损率） | 91.80% |
| Fee drag（手续费拖累） | 112.83 USDT |
| Tail max single loss（最大单笔亏损） | -117.17 USDT |
| CAGR（年化复合收益率） | -7.82% |
| Sharpe（夏普比率） | -0.40 |
| Sortino（索提诺比率） | -0.37 |
| Exposure（持仓暴露时间） | 51.46% |
| Turnover（换手率） | 8.57 |
...
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.35 | 1,923.92 | 101.42 | 100.51 | 1.01 | 0.90 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 649.91 | 680.91 | 4.84 | 150.07 | 145.52 | 1.48 | 4.55 | Stop loss hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 188.83 | -101.12 | -102.93 | -1.03 | 1.80 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-06-30T08:00:00+00:00 | 269.57 | 299.94 | 4.93 | 149.63 | 147.62 | 1.48 | 2.01 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-07-06T20:00:00+00:00 | 0.88 | 0.93 | 1,299.22 | 72.65 | 70.98 | 0.70 | 1.67 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-11T00:00:00+00:00 | 512.91 | 486.01 | 3.97 | -106.79 | -109.53 | -1.04 | 2.74 | Stop loss hit. |
| `FETUSDT` | STOPPED（已止损） | 2025-07-11T16:00:00+00:00 | 0.73 | 0.81 | 1,394.50 | 111.76 | 110.23 | 1.05 | 1.53 | Stop loss hit. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-12T16:00:00+00:00 | 0.00 | 0.00 | 27,242,920.29 | 262.70 | 262.09 | 2.55 | 0.61 | TP2 hit; paper trade closed. |
| `TRXUSDT` | STOPPED（已止损） | 2025-07-13T00:00:00+00:00 | 0.30 | 0.32 | 7,147.92 | 132.54 | 129.41 | 1.24 | 3.13 | Stop loss hit. |
| `TAOUSDT` | STOPPED（已止损） | 2025-07-15T04:00:00+00:00 | 406.16 | 367.53 | 2.72 | -104.97 | -106.41 | -1.02 | 1.44 | Stop loss hit. |
| `PNUTUSDT` | STOPPED（已止损） | 2025-07-15T16:00:00+00:00 | 0.28 | 0.31 | 4,017.37 | 108.19 | 106.51 | 0.99 | 1.68 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 191.05 | -109.28 | -110.23 | -1.01 | 0.95 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-19T16:00:00+00:00 | 0.96 | 0.79 | 631.91 | -108.63 | -109.38 | -1.01 | 0.74 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-07-20T12:00:00+00:00 | 0.00 | 0.00 | 90,000,560.03 | -111.29 | -112.90 | -1.02 | 1.61 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.88 | 0.79 | 1,251.69 | -111.04 | -112.47 | -1.02 | 1.43 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-22T20:00:00+00:00 | 766.05 | 813.76 | 2.07 | 98.84 | 96.52 | 0.90 | 2.32 | Stop loss hit. |
| `ENAUSDT` | CLOSED（已按TP2平仓） | 2025-07-24T12:00:00+00:00 | 0.48 | 0.66 | 1,767.17 | 314.17 | 313.37 | 2.90 | 0.80 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.42 | -112.82 | -114.92 | -1.03 | 2.10 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 187.57 | 172.82 | 7.81 | -115.23 | -117.17 | -1.03 | 1.94 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 3,507.48 | -109.48 | -110.40 | -1.01 | 0.92 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,293.35 | -111.03 | -112.03 | -1.02 | 0.99 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 127.54 | 13.77 | 87.50 | 85.07 | 0.80 | 2.42 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 174.47 | 193.40 | 6.74 | 127.48 | 125.70 | 1.18 | 1.77 | Stop loss hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-08-11T08:00:00+00:00 | 11.03 | 11.54 | 147.15 | 73.88 | 71.53 | 0.66 | 2.35 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-08-12T00:00:00+00:00 | 580.53 | 550.36 | 3.60 | -108.66 | -111.48 | -1.05 | 2.82 | Stop loss hit. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-12T04:00:00+00:00 | 5.51 | 5.15 | 299.07 | -109.10 | -111.30 | -1.03 | 2.20 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-08-12T08:00:00+00:00 | 3.42 | 3.24 | 599.70 | -108.59 | -111.36 | -1.04 | 2.76 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-08-14T20:00:00+00:00 | 0.90 | 0.75 | 712.84 | -106.71 | -107.50 | -1.01 | 0.79 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.00 | 0.00 | 59,795,991.07 | -104.30 | -105.15 | -1.01 | 0.85 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-08-23T04:00:00+00:00 | 0.03 | 0.03 | 15,578.00 | -104.02 | -104.67 | -1.01 | 0.66 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-11T04:00:00+00:00 | 4,385.13 | 4,584.26 | 0.59 | 117.10 | 113.37 | 1.12 | 3.73 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-09-14T08:00:00+00:00 | 115,660.16 | 111,616.82 | 0.03 | -105.82 | -109.95 | -1.07 | 4.13 | Stop loss hit. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T00:00:00+00:00 | 29.85 | 34.86 | 49.69 | 249.15 | 247.86 | 2.43 | 1.29 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T08:00:00+00:00 | 930.05 | 1,025.84 | 3.11 | 297.96 | 295.53 | 2.87 | 2.43 | TP2 hit; paper trade closed. |
| `XRPUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 3.04 | 2.91 | 690.00 | -92.12 | -94.97 | -1.05 | 2.84 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 0.35 | 0.34 | 5,000.50 | -46.79 | -49.17 | -1.09 | 2.38 | Stop loss hit. |
| `CAKEUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 2.89 | 2.59 | 362.28 | -107.66 | -109.02 | -1.02 | 1.36 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 5.48 | -103.92 | -105.50 | -1.03 | 1.58 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 51.41 | -104.06 | -105.58 | -1.03 | 1.52 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.85 | 0.77 | 1,306.40 | -103.99 | -105.43 | -1.02 | 1.44 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.03 | 0.03 | 19,058.51 | -103.20 | -103.94 | -1.01 | 0.74 | Stop loss hit. |
| `HBARUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.23 | 0.21 | 4,827.02 | -105.01 | -106.44 | -1.02 | 1.43 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.41 | -98.86 | -100.63 | -1.03 | 1.78 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 2.81 | -100.87 | -104.49 | -1.06 | 3.62 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 9.68 | -98.26 | -99.25 | -1.02 | 0.99 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 20,024.49 | -94.30 | -94.67 | -1.01 | 0.37 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-16T00:00:00+00:00 | 2,346.05 | 2,140.90 | 0.46 | -94.66 | -96.08 | -1.03 | 1.42 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2026-04-17T00:00:00+00:00 | 9.63 | 9.06 | 172.87 | -97.32 | -99.55 | -1.04 | 2.23 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2026-04-17T00:00:00+00:00 | 9.38 | 10.40 | 161.04 | 164.04 | 161.76 | 1.73 | 2.28 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-04-17T08:00:00+00:00 | 0.00 | 0.00 | 221,709,743.86 | 81.55 | 80.26 | 0.86 | 1.29 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-04T16:00:00+00:00 | 1.40 | 1.45 | 2,194.03 | 96.38 | 91.97 | 0.96 | 4.41 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2026-05-10T16:00:00+00:00 | 2.43 | 2.24 | 524.13 | -99.82 | -101.50 | -1.03 | 1.68 | Stop loss hit. |
| `APTUSDT` | STOPPED（已止损） | 2026-05-11T04:00:00+00:00 | 1.12 | 1.01 | 917.93 | -98.53 | -99.87 | -1.02 | 1.34 | Stop loss hit. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2025-06-10T12:00:00+00:00 | 658.16 - 660.19 | 45.17 | Backtest WATCHING plan expired before entry. |
...
| `ETHUSDT` | EXPIRED（观察计划过期） | 2025-06-30T00:00:00+00:00 | 2,470.80 - 2,485.56 | 69.44 | Backtest WATCHING plan expired before entry. |
...
| `SOLUSDT` | EXPIRED（观察计划过期） | 2025-07-03T00:00:00+00:00 | 150.46 - 152.22 | 54.88 | Backtest WATCHING plan expired before entry. |
| `ETHUSDT` | EXPIRED（观察计划过期） | 2025-07-03T04:00:00+00:00 | 2,489.21 - 2,515.08 | 71.16 | Backtest WATCHING plan expired before entry. |
| `TRXUSDT` | EXPIRED（观察计划过期） | 2025-07-03T08:00:00+00:00 | 0.28 - 0.28 | 59.36 | Backtest WATCHING plan expired before entry. |
...
| `TRXUSDT` | EXPIRED（观察计划过期） | 2025-07-06T12:00:00+00:00 | 0.28 - 0.28 | 46.79 | Backtest WATCHING plan expired before entry. |
...
| `PENGUUSDT` | EXPIRED（观察计划过期） | 2025-07-08T20:00:00+00:00 | 0.02 - 0.02 | 49.15 | Backtest WATCHING plan expired before entry. |
...
| `WIFUSDT` | EXPIRED（观察计划过期） | 2025-07-13T12:00:00+00:00 | 0.97 - 0.99 | 53.91 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2025-10-03T20:00:00+00:00 | 0.25 - 0.26 | 68.13 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | INVALIDATED（未入场前失效） | 2025-10-07T00:00:00+00:00 | 0.26 - 0.26 | 74.31 | Plan invalidated before entry: current price is below stop loss. |
...
| `ETHUSDT` | INVALIDATED（未入场前失效） | 2025-10-08T20:00:00+00:00 | 4,469.20 - 4,522.81 | 41.94 | Plan invalidated before entry: current price is below stop loss. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2026-04-18T00:00:00+00:00 | 0.10 - 0.10 | 66.91 | Backtest WATCHING plan expired before entry. |
...
| `DOGEUSDT` | EXPIRED（观察计划过期） | 2026-04-21T04:00:00+00:00 | 0.09 - 0.10 | 41.87 | Backtest WATCHING plan expired before entry. |
...
| `BNBUSDT` | EXPIRED（观察计划过期） | 2026-04-23T00:00:00+00:00 | 636.22 - 639.38 | 62.90 | Backtest WATCHING plan expired before entry. |
...
| `ADAUSDT` | EXPIRED（观察计划过期） | 2026-05-07T00:00:00+00:00 | 0.26 - 0.26 | 64.23 | Backtest WATCHING plan expired before entry. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T07:34:47+00:00",
