...
# 回测报告 2025-06-01 至 2026-06-01 v19
...
|---|---:|
| Trades（计划总数） | 324 |
| Closed trades（已结束交易） | 93 |
| Open trades（仍开放持仓） | 0 |
| Win rate（胜率） | 52.69% |
| Profit factor（盈利因子） | 1.64 |
| Avg R（平均R倍数） | 0.29 |
| Net return（净收益率） | 26.93% |
| Max drawdown（最大回撤） | 1,249.26 / 9.27% |
| Intrabar max drawdown（K线内最大回撤） | 1,164.93 / 8.76% |
| TP1 touched rate（第一止盈触达率） | 30.11% |
| TP2 close rate（第二止盈平仓率） | 15.05% |
| Stop rate（止损率） | 48.39% |
| Fee drag（手续费拖累） | 208.07 USDT |
| Tail max single loss（最大单笔亏损） | -137.27 USDT |
| CAGR（年化复合收益率） | 26.93% |
| Sharpe（夏普比率） | 1.43 |
| Sortino（索提诺比率） | 1.28 |
| Exposure（持仓暴露时间） | 35.11% |
| Turnover（换手率） | 15.98 |
...
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-06-08T00:00:00+00:00 | 105,888.73 | 105,458.44 | 0.01 | -6.17 | -8.30 | -0.08 | 2.12 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
...
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-06-28T00:00:00+00:00 | 107,328.13 | 108,046.57 | 0.03 | 23.68 | 18.70 | 0.18 | 4.98 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,527.80 | 1.00 | 78.74 | 75.23 | 0.74 | 3.51 | EMA20 trailing stop hit. |
| `SEIUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.27 | 1,960.78 | -58.24 | -59.00 | -0.58 | 0.76 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `BNBUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-06-30T00:00:00+00:00 | 649.91 | 660.95 | 4.92 | 54.26 | 49.73 | 0.50 | 4.53 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 192.45 | -103.06 | -104.90 | -1.03 | 1.84 | Stop loss hit. |
| `ARBUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-06-30T16:00:00+00:00 | 0.34 | 0.34 | 562.92 | -0.30 | -0.57 | -0.02 | 0.27 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `UNIUSDT` | STOPPED（已止损） | 2025-07-03T00:00:00+00:00 | 7.25 | 8.36 | 117.67 | 130.96 | 129.63 | 1.29 | 1.33 | EMA20 trailing stop hit. |
| `TRXUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T00:00:00+00:00 | 0.28 | 0.30 | 16,964.14 | 368.14 | 364.15 | 3.55 | 3.99 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T16:00:00+00:00 | 0.17 | 0.20 | 9,041.48 | 275.15 | 273.81 | 2.68 | 1.34 | TP2 hit; paper trade closed. |
| `BTCUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T20:00:00+00:00 | 108,710.18 | 119,019.48 | 0.01 | 89.95 | 89.16 | 3.32 | 0.79 | TP2 hit; paper trade closed. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-09T04:00:00+00:00 | 662.52 | 689.74 | 2.86 | 77.96 | 75.23 | 1.40 | 2.73 | EMA20 trailing stop hit. |
| `BONKUSDT` | CLOSED（已按TP2平仓） | 2025-07-10T08:00:00+00:00 | 0.00 | 0.00 | 42,274,493.42 | 269.21 | 268.36 | 2.44 | 0.85 | TP2 hit; paper trade closed. |
| `AAVEUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-07-11T04:00:00+00:00 | 301.27 | 315.99 | 4.26 | 62.71 | 60.85 | 0.54 | 1.86 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `TONUSDT` | STOPPED（已止损） | 2025-07-12T00:00:00+00:00 | 2.94 | 3.17 | 564.27 | 126.33 | 123.88 | 1.11 | 2.45 | EMA20 trailing stop hit. |
| `SHIBUSDT` | STOPPED（已止损） | 2025-07-12T08:00:00+00:00 | 0.00 | 0.00 | 75,739,296.60 | 82.65 | 81.17 | 0.72 | 1.48 | EMA20 trailing stop hit. |
| `LINKUSDT` | CLOSED（已按TP2平仓） | 2025-07-13T08:00:00+00:00 | 15.26 | 18.48 | 91.19 | 294.39 | 293.16 | 2.57 | 1.23 | TP2 hit; paper trade closed. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T04:00:00+00:00 | 163.62 | 184.55 | 13.83 | 289.46 | 287.53 | 2.52 | 1.93 | TP2 hit; paper trade closed. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-07-16T04:00:00+00:00 | 0.00 | 0.00 | 99,964,280.89 | 106.89 | 105.01 | 0.86 | 1.88 | EMA20 trailing stop hit. |
| `SUIUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-07-16T20:00:00+00:00 | 3.96 | 3.62 | 210.53 | -71.88 | -72.98 | -0.59 | 1.09 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `LINKUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-07-18T20:00:00+00:00 | 17.64 | 18.26 | 52.63 | 32.58 | 31.25 | 0.26 | 1.33 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `OPUSDT` | STOPPED（已止损） | 2025-07-19T00:00:00+00:00 | 0.75 | 0.67 | 1,567.80 | -123.40 | -124.93 | -1.02 | 1.52 | Stop loss hit. |
| `HBARUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-07-19T16:00:00+00:00 | 0.27 | 0.29 | 2,943.29 | 72.00 | 70.83 | 0.58 | 1.17 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ARBUSDT` | STOPPED（已止损） | 2025-07-21T00:00:00+00:00 | 0.48 | 0.43 | 2,556.42 | -124.89 | -126.48 | -1.02 | 1.59 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-07-22T20:00:00+00:00 | 766.05 | 813.76 | 2.30 | 109.95 | 107.36 | 0.90 | 2.58 | EMA20 trailing stop hit. |
| `ENAUSDT` | CLOSED（已按TP2平仓） | 2025-07-24T12:00:00+00:00 | 0.48 | 0.66 | 1,929.50 | 343.03 | 342.15 | 2.90 | 0.88 | TP2 hit; paper trade closed. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-24T12:00:00+00:00 | 1.00 | 0.89 | 1,072.43 | -123.11 | -124.49 | -1.02 | 1.38 | Stop loss hit. |
| `UNIUSDT` | STOPPED（已止损） | 2025-07-24T16:00:00+00:00 | 10.39 | 9.47 | 133.68 | -123.54 | -125.36 | -1.03 | 1.82 | Stop loss hit. |
| `CFXUSDT` | CLOSED（已按TP2平仓） | 2025-07-25T16:00:00+00:00 | 0.18 | 0.26 | 4,711.02 | 365.90 | 365.07 | 2.93 | 0.83 | TP2 hit; paper trade closed. |
| `TAOUSDT` | STOPPED（已止损） | 2025-07-26T12:00:00+00:00 | 427.89 | 395.67 | 3.99 | -128.64 | -130.90 | -1.03 | 2.26 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.47 | -126.19 | -128.53 | -1.03 | 2.34 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 118,552.38 | 112,889.31 | 0.02 | -131.57 | -135.30 | -1.05 | 3.72 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-07-30T00:00:00+00:00 | 3.35 | 3.56 | 576.89 | 119.25 | 116.42 | 0.91 | 2.83 | EMA20 trailing stop hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 127.54 | 15.99 | 101.64 | 98.82 | 0.80 | 2.81 | EMA20 trailing stop hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 0.34 | 0.35 | 9,773.88 | 166.02 | 161.23 | 1.29 | 4.79 | EMA20 trailing stop hit. |
| `BCHUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-08-08T00:00:00+00:00 | 576.71 | 597.90 | 2.86 | 60.69 | 58.32 | 0.47 | 2.37 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `SOLUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 174.47 | 193.40 | 7.82 | 148.08 | 146.02 | 1.18 | 2.06 | EMA20 trailing stop hit. |
| `ENAUSDT` | CLOSED（已按TP2平仓） | 2025-08-08T08:00:00+00:00 | 0.63 | 0.83 | 1,600.19 | 318.66 | 317.73 | 2.55 | 0.93 | TP2 hit; paper trade closed. |
| `XRPUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-08-08T16:00:00+00:00 | 3.19 | 2.99 | 385.79 | -78.38 | -80.03 | -0.62 | 1.64 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-12T04:00:00+00:00 | 5.51 | 5.15 | 363.93 | -132.77 | -135.44 | -1.03 | 2.67 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2025-08-12T08:00:00+00:00 | 3.42 | 3.24 | 729.77 | -132.15 | -135.51 | -1.04 | 3.36 | Stop loss hit. |
| `ADAUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-08-14T20:00:00+00:00 | 0.90 | 0.85 | 865.02 | -45.16 | -46.21 | -0.36 | 1.05 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `BERAUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-08-15T08:00:00+00:00 | 2.15 | 2.42 | 446.41 | 118.78 | 117.32 | 0.91 | 1.46 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-15T08:00:00+00:00 | 5.44 | 5.82 | 282.94 | 107.69 | 105.43 | 0.81 | 2.26 | EMA20 trailing stop hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.00 | 0.00 | 74,466,072.07 | -129.89 | -130.95 | -1.01 | 1.06 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 3.74 | 3.25 | 267.89 | -130.13 | -131.40 | -1.02 | 1.27 | Stop loss hit. |
| `PENGUUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-08-23T04:00:00+00:00 | 0.03 | 0.03 | 19,399.84 | -99.45 | -100.30 | -0.78 | 0.85 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ADAUSDT` | STOPPED（已止损） | 2025-08-23T12:00:00+00:00 | 0.91 | 0.81 | 1,263.42 | -131.06 | -132.54 | -1.02 | 1.48 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-11T04:00:00+00:00 | 4,385.13 | 4,584.26 | 0.73 | 144.64 | 140.03 | 1.12 | 4.60 | EMA20 trailing stop hit. |
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-09-14T08:00:00+00:00 | 115,660.16 | 115,364.57 | 0.03 | -9.55 | -14.77 | -0.12 | 5.22 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T00:00:00+00:00 | 29.85 | 34.86 | 61.43 | 307.98 | 306.39 | 2.43 | 1.59 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T08:00:00+00:00 | 930.05 | 1,025.84 | 3.84 | 368.20 | 365.19 | 2.87 | 3.01 | TP2 hit; paper trade closed. |
| `XRPUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 3.04 | 2.91 | 973.20 | -129.93 | -133.95 | -1.05 | 4.01 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 0.35 | 0.34 | 6,181.23 | -57.84 | -60.78 | -1.09 | 2.94 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-09-16T16:00:00+00:00 | 3.63 | 3.40 | 111.41 | -25.10 | -25.64 | -1.04 | 0.54 | Stop loss hit. |
| `NEARUSDT` | STOPPED（已止损） | 2025-09-21T00:00:00+00:00 | 3.14 | 2.76 | 347.24 | -132.59 | -133.99 | -1.02 | 1.39 | Stop loss hit. |
| `CAKEUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 2.89 | 2.59 | 446.96 | -132.83 | -134.51 | -1.02 | 1.68 | Stop loss hit. |
| `SOLUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-10-02T00:00:00+00:00 | 220.00 | 225.96 | 6.79 | 40.49 | 38.35 | 0.30 | 2.13 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `LINKUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-10-02T00:00:00+00:00 | 22.59 | 22.25 | 63.78 | -21.82 | -23.81 | -0.19 | 2.00 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ADAUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-10-02T04:00:00+00:00 | 0.85 | 0.80 | 1,620.59 | -68.01 | -69.86 | -0.55 | 1.85 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `PENGUUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-10-02T04:00:00+00:00 | 0.03 | 0.03 | 23,642.13 | -18.58 | -19.61 | -0.15 | 1.03 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `AAVEUSDT` | TIME_EXIT（未触TP1超时退出） | 2025-10-02T04:00:00+00:00 | 288.35 | 271.67 | 4.92 | -82.04 | -83.94 | -0.65 | 1.90 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `BNBUSDT` | STOPPED（已止损） | 2025-10-08T16:00:00+00:00 | 1,276.38 | 1,129.49 | 0.87 | -127.79 | -129.21 | -1.02 | 1.43 | Stop loss hit. |
| `LTCUSDT` | CLOSED（已按TP2平仓） | 2025-10-09T04:00:00+00:00 | 118.79 | 133.51 | 23.55 | 346.64 | 344.26 | 2.73 | 2.38 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.53 | -129.87 | -132.20 | -1.03 | 2.33 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 3.70 | -132.51 | -137.27 | -1.06 | 4.76 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 12.72 | -129.09 | -130.39 | -1.02 | 1.30 | Stop loss hit. |
| `ROSEUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.02 | 26,306.51 | 128.66 | 127.93 | 1.04 | 0.74 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-15T20:00:00+00:00 | 74,414.13 | 77,626.92 | 0.03 | 81.63 | 78.91 | 0.63 | 2.73 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ETHUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-16T00:00:00+00:00 | 2,346.05 | 2,310.57 | 0.64 | -22.59 | -24.66 | -0.19 | 2.07 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `PEPEUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 408,134,704.24 | 16.63 | 14.50 | 0.12 | 2.13 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `SOLUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-16T00:00:00+00:00 | 85.20 | 85.70 | 25.27 | 12.81 | 9.78 | 0.08 | 3.03 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `DOGEUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-16T00:00:00+00:00 | 0.09 | 0.10 | 23,003.05 | 15.22 | 12.15 | 0.10 | 3.07 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-24T00:00:00+00:00 | 78,189.95 | 77,386.52 | 0.03 | -22.66 | -25.72 | -0.20 | 3.06 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ENJUSDT` | STOPPED（已止损） | 2026-04-25T00:00:00+00:00 | 0.06 | 0.06 | 17,531.80 | -126.65 | -128.06 | -1.02 | 1.41 | Stop loss hit. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-25T04:00:00+00:00 | 0.10 | 0.11 | 28,062.64 | 335.20 | 332.86 | 2.63 | 2.34 | TP2 hit; paper trade closed. |
| `SOLUSDT` | STOPPED（已止损） | 2026-04-26T08:00:00+00:00 | 86.79 | 83.13 | 35.37 | -129.37 | -133.54 | -1.06 | 4.17 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-26T08:00:00+00:00 | 2,337.96 | 2,248.89 | 1.46 | -130.30 | -134.96 | -1.06 | 4.66 | Stop loss hit. |
| `ZBTUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-04-27T12:00:00+00:00 | 0.17 | 0.19 | 2,410.87 | 39.09 | 38.47 | 0.30 | 0.62 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `DOGEUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-02T00:00:00+00:00 | 0.11 | 0.11 | 12,574.17 | 29.46 | 27.53 | 0.22 | 1.93 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `PEPEUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-02T00:00:00+00:00 | 0.00 | 0.00 | 468,622,660.10 | 136.82 | 134.09 | 1.06 | 2.73 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `ETHUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-03T00:00:00+00:00 | 2,315.14 | 2,320.26 | 1.08 | 5.53 | 2.02 | 0.02 | 3.50 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `LINKUSDT` | STOPPED（已止损） | 2026-05-05T00:00:00+00:00 | 9.36 | 9.79 | 294.95 | 128.18 | 124.19 | 0.97 | 3.99 | EMA20 trailing stop hit. |
| `BTCUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-08T16:00:00+00:00 | 80,327.98 | 79,004.10 | 0.06 | -74.07 | -80.29 | -0.61 | 6.22 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `TAOUSDT` | STOPPED（已止损） | 2026-05-09T00:00:00+00:00 | 310.84 | 279.36 | 4.13 | -129.92 | -131.59 | -1.02 | 1.67 | Stop loss hit. |
| `BNBUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-09T00:00:00+00:00 | 646.54 | 652.12 | 3.07 | 17.13 | 14.33 | 0.17 | 2.80 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-09T04:00:00+00:00 | 1.42 | 1.45 | 1,776.32 | 61.56 | 57.97 | 0.53 | 3.59 | EMA20 trailing stop hit. |
| `TRXUSDT` | TIME_EXIT（未触TP1超时退出） | 2026-05-09T12:00:00+00:00 | 0.35 | 0.36 | 7,151.87 | 44.88 | 41.33 | 0.46 | 3.55 | Time exit: TP1 not touched within max_holding_bars_without_tp1. |
...
| `WIFUSDT` | EXPIRED（观察计划过期） | 2025-07-06T20:00:00+00:00 | 0.86 - 0.88 | 63.80 | Backtest WATCHING plan expired before entry. |
...
| `BTCUSDT` | EXPIRED（观察计划过期） | 2025-07-18T08:00:00+00:00 | 118,882.28 - 119,683.75 | 65.09 | Backtest WATCHING plan expired before entry. |
...
| `WIFUSDT` | EXPIRED（观察计划过期） | 2025-07-20T04:00:00+00:00 | 1.06 - 1.09 | 68.82 | Backtest WATCHING plan expired before entry. |
| `FILUSDT` | INVALIDATED（未入场前失效） | 2025-07-21T12:00:00+00:00 | 2.84 - 2.89 | 68.91 | Plan invalidated before entry: current price is below stop loss. |
...
| `ENSUSDT` | EXPIRED（观察计划过期） | 2025-07-23T08:00:00+00:00 | 28.13 - 28.74 | 70.96 | Backtest WATCHING plan expired before entry. |
...
| `SOLUSDT` | EXPIRED（观察计划过期） | 2025-07-27T04:00:00+00:00 | 186.64 - 187.75 | 62.80 | Backtest WATCHING plan expired before entry. |
...
| `BTCUSDT` | EXPIRED（观察计划过期） | 2025-08-11T20:00:00+00:00 | 118,823.63 - 119,446.57 | 69.58 | Backtest WATCHING plan expired before entry. |
...
| `ETHUSDT` | INVALIDATED（未入场前失效） | 2026-05-11T12:00:00+00:00 | 2,336.73 - 2,342.81 | 64.00 | Plan invalidated before entry: current price is below stop loss. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T14:30:22+00:00",
