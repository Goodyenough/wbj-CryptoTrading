---
created: 2026-06-11 22:26:41 CST
tags:
  - crypto
  - trading-system
  - backtest
backtest_run_id: 275703aee923
report_version: v18
...
# 回测报告 2025-06-01 至 2026-06-01 v18
...
| Open trades（仍开放持仓） | 2 |
| Win rate（胜率） | 42.11% |
| Profit factor（盈利因子） | 1.17 |
| Avg R（平均R倍数） | 0.13 |
| Net return（净收益率） | 5.46% |
| Max drawdown（最大回撤） | 2,226.45 / 17.78% |
| Intrabar max drawdown（K线内最大回撤） | 2,168.91 / 17.45% |
| TP1 touched rate（第一止盈触达率） | 40.35% |
| TP2 close rate（第二止盈平仓率） | 17.54% |
| Stop rate（止损率） | 82.46% |
| Fee drag（手续费拖累） | 110.16 USDT |
| Tail max single loss（最大单笔亏损） | -128.49 USDT |
| CAGR（年化复合收益率） | 5.46% |
| Sharpe（夏普比率） | 0.40 |
| Sortino（索提诺比率） | 0.40 |
| Exposure（持仓暴露时间） | 49.09% |
| Turnover（换手率） | 8.85 |
...
| `PEPEUSDT` | STOPPED（已止损） | 2025-07-16T04:00:00+00:00 | 0.00 | 0.00 | 98,206,412.72 | 105.01 | 103.16 | 0.86 | 1.85 | EMA20 trailing stop hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T04:00:00+00:00 | 9.20 | 11.53 | 128.61 | 300.47 | 299.41 | 2.47 | 1.07 | TP2 hit; paper trade closed. |
| `WLDUSDT` | STOPPED（已止损） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.19 | 1,213.06 | 142.80 | 140.83 | 1.19 | 1.97 | EMA20 trailing stop hit. |
| `HBARUSDT` | CLOSED（已按TP2平仓） | 2025-07-17T08:00:00+00:00 | 0.24 | 0.28 | 6,125.72 | 270.28 | 269.00 | 2.33 | 1.28 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-17T12:00:00+00:00 | 3.99 | 3.75 | 482.89 | -117.59 | -120.18 | -1.04 | 2.58 | Stop loss hit. |
| `APTUSDT` | STOPPED（已止损） | 2025-07-18T00:00:00+00:00 | 5.24 | 4.71 | 226.46 | -120.80 | -122.34 | -1.02 | 1.54 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-18T20:00:00+00:00 | 17.64 | 21.05 | 51.70 | 176.34 | 174.89 | 1.47 | 1.45 | EMA20 trailing stop hit. |
| `HBARUSDT` | STOPPED（已止损） | 2025-07-19T16:00:00+00:00 | 0.27 | 0.23 | 2,970.65 | -124.60 | -125.58 | -1.01 | 0.99 | Stop loss hit. |
| `CRVUSDT` | STOPPED（已止损） | 2025-07-19T16:00:00+00:00 | 0.96 | 0.79 | 732.79 | -125.97 | -126.84 | -1.01 | 0.86 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-07-21T20:00:00+00:00 | 0.87 | 0.78 | 1,374.29 | -125.33 | -126.89 | -1.02 | 1.56 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-07-22T12:00:00+00:00 | 119,117.21 | 114,271.69 | 0.03 | -124.34 | -128.49 | -1.06 | 4.15 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 3,799.11 | -118.59 | -119.58 | -1.01 | 0.99 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-08-07T20:00:00+00:00 | 116,469.80 | 110,849.29 | 0.02 | -124.61 | -128.10 | -1.05 | 3.49 | Stop loss hit. |
| `PENDLEUSDT` | STOPPED（已止损） | 2025-08-12T08:00:00+00:00 | 5.48 | 5.15 | 361.31 | -121.66 | -124.31 | -1.04 | 2.65 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-08-14T20:00:00+00:00 | 0.90 | 0.75 | 789.73 | -118.22 | -119.10 | -1.01 | 0.88 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-08-23T04:00:00+00:00 | 26.04 | 23.60 | 48.10 | -117.55 | -119.19 | -1.02 | 1.64 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-11T04:00:00+00:00 | 4,385.13 | 4,584.26 | 0.66 | 131.62 | 127.43 | 1.12 | 4.19 | EMA20 trailing stop hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-09-14T08:00:00+00:00 | 115,660.16 | 111,616.82 | 0.03 | -118.94 | -123.59 | -1.07 | 4.64 | Stop loss hit. |
| `AVAXUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T00:00:00+00:00 | 29.85 | 34.86 | 55.86 | 280.05 | 278.60 | 2.43 | 1.45 | TP2 hit; paper trade closed. |
| `BNBUSDT` | CLOSED（已按TP2平仓） | 2025-09-16T08:00:00+00:00 | 930.05 | 1,025.84 | 3.50 | 334.92 | 332.18 | 2.87 | 2.74 | TP2 hit; paper trade closed. |
| `XRPUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 3.04 | 2.91 | 778.90 | -103.99 | -107.20 | -1.05 | 3.21 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 0.35 | 0.34 | 5,620.75 | -52.60 | -55.27 | -1.09 | 2.67 | Stop loss hit. |
| `CAKEUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 2.89 | 2.59 | 407.20 | -121.01 | -122.54 | -1.02 | 1.53 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 6.16 | -116.82 | -118.60 | -1.03 | 1.78 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 22.59 | 20.57 | 57.79 | -116.97 | -118.68 | -1.03 | 1.71 | Stop loss hit. |
| `ADAUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.85 | 0.77 | 1,468.55 | -116.90 | -118.52 | -1.02 | 1.62 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 0.03 | 0.03 | 21,424.05 | -116.01 | -116.84 | -1.01 | 0.83 | Stop loss hit. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-10-02T04:00:00+00:00 | 288.35 | 261.85 | 4.46 | -118.12 | -119.80 | -1.02 | 1.68 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-16T04:00:00+00:00 | 3,306.75 | 3,062.71 | 0.46 | -111.13 | -113.12 | -1.03 | 2.00 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 3.16 | -113.39 | -117.45 | -1.06 | 4.07 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 10.88 | -110.46 | -111.57 | -1.02 | 1.11 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 22,509.61 | -106.01 | -106.42 | -1.01 | 0.41 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-16T00:00:00+00:00 | 2,346.05 | 2,140.90 | 0.53 | -109.50 | -111.14 | -1.03 | 1.64 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 342,158,208.84 | 127.40 | 125.50 | 1.19 | 1.90 | EMA20 trailing stop hit. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 85.20 | 98.36 | 21.18 | 278.77 | 277.21 | 2.61 | 1.56 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.09 | 0.11 | 19,284.52 | 270.88 | 269.31 | 2.53 | 1.57 | TP2 hit; paper trade closed. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-06T16:00:00+00:00 | 0.00 | 0.00 | 345,762,726.03 | -113.16 | -115.06 | -1.03 | 1.90 | Stop loss hit. |
| `TONUSDT` | STOPPED（已止损） | 2026-05-10T16:00:00+00:00 | 2.43 | 2.24 | 605.10 | -115.24 | -117.18 | -1.03 | 1.94 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-12T04:00:00+00:00 | 1.46 | 1.39 | 1,496.30 | -113.82 | -116.78 | -1.05 | 2.95 | Stop loss hit. |
...
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 2,080.79 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `XLMUSDT` | EXPIRED（观察计划过期） | 2025-07-17T16:00:00+00:00 | 0.45 - 0.47 | 73.68 | Backtest WATCHING plan expired before entry. |
...
| `FETUSDT` | INVALIDATED（未入场前失效） | 2025-07-22T04:00:00+00:00 | 0.81 - 0.83 | 73.50 | Plan invalidated before entry: current price is below stop loss. |
...
| `LTCUSDT` | EXPIRED（观察计划过期） | 2025-08-08T00:00:00+00:00 | 119.40 - 121.13 | 67.61 | Backtest WATCHING plan expired before entry. |
...
| `LTCUSDT` | EXPIRED（观察计划过期） | 2025-08-11T04:00:00+00:00 | 122.81 - 124.86 | 70.05 | Backtest WATCHING plan expired before entry. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T14:26:41+00:00",
