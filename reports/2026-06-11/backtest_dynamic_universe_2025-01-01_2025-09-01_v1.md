---
created: 2026-06-11 10:03:41 CST
tags:
  - crypto
  - trading-system
  - backtest
backtest_run_id: 8a881bbd789e
report_version: v1
...
|---|---:|
| Trades（计划总数） | 271 |
| Closed trades（已结束交易） | 42 |
| Open trades（仍开放持仓） | 5 |
| Win rate（胜率） | 19.05% |
| Profit factor（盈利因子） | 0.58 |
| Avg R（平均R倍数） | -0.32 |
| Net return（净收益率） | -13.17% |
| Max drawdown（最大回撤） | 1,999.70 / 19.43% |
| Intrabar max drawdown（K线内最大回撤） | 1,981.13 / 19.39% |
| TP1 touched rate（第一止盈触达率） | 30.95% |
| TP2 close rate（第二止盈平仓率） | 19.05% |
| Stop rate（止损率） | 80.95% |
| Fee drag（手续费拖累） | 51.19 USDT |
...
| `BCHUSDT` | STOPPED（已止损） | 2025-07-11T00:00:00+00:00 | 512.91 | 486.01 | 3.46 | -93.06 | -95.45 | -1.04 | 2.39 | Stop loss hit. |
| `ADAUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T12:00:00+00:00 | 0.74 | 0.88 | 1,533.75 | 225.09 | 224.09 | 2.45 | 1.00 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.32 | 953.39 | 230.54 | 229.63 | 2.46 | 0.91 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 167.76 | -95.96 | -96.79 | -1.01 | 0.83 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 26,836,560.14 | -96.28 | -97.49 | -1.02 | 1.21 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 19.38 | 17.25 | 46.45 | -98.81 | -99.98 | -1.02 | 1.16 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-07-28T00:00:00+00:00 | 0.04 | 0.04 | 11,765.05 | -95.17 | -95.78 | -1.01 | 0.61 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 2,998.23 | -93.59 | -94.37 | -1.01 | 0.78 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,065.63 | -91.48 | -92.30 | -1.02 | 0.82 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 11.95 | -93.65 | -95.58 | -1.04 | 1.93 | Stop loss hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-08-14T08:00:00+00:00 | 0.83 | 0.71 | 782.14 | -91.80 | -92.62 | -1.01 | 0.81 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 575.15 | -90.26 | -90.92 | -1.01 | 0.66 | Stop loss hit. |
...
| `ARKUSDT` | ENTERED（已入场） | 0.46 | 1,076.07 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BERAUSDT` | TP1_HIT（第一止盈已触达） | 2.15 | 308.57 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T02:03:41+00:00",
