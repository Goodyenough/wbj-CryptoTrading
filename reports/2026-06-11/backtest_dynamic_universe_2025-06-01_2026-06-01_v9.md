...
| Avg R（平均R倍数） | -0.20 |
| Net return（净收益率） | -10.88% |
| Max drawdown（最大回撤） | 2,714.47 / 24.24% |
| Intrabar max drawdown（K线内最大回撤） | 2,673.73 / 23.99% |
| TP1 touched rate（第一止盈触达率） | 34.69% |
| TP2 close rate（第二止盈平仓率） | 22.45% |
| Stop rate（止损率） | 77.55% |
| Fee drag（手续费拖累） | 81.13 USDT |
| Tail max single loss（最大单笔亏损） | -114.60 USDT |
| CAGR（年化复合收益率） | -10.88% |
| Sharpe（夏普比率） | -0.57 |
| Sortino（索提诺比率） | -0.68 |
| Exposure（持仓暴露时间） | 88.04% |
| Turnover（换手率） | 6.76 |
...
| `TRBUSDT` | STOPPED（已止损） | 2025-06-08T00:00:00+00:00 | 49.05 | 41.65 | 13.50 | -99.83 | -100.66 | -1.01 | 0.83 | Stop loss hit. |
| `UNIUSDT` | CLOSED（已按TP2平仓） | 2025-06-08T00:00:00+00:00 | 6.37 | 8.20 | 150.19 | 275.66 | 274.78 | 2.77 | 0.88 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2025-06-08T12:00:00+00:00 | 2,522.31 | 2,343.42 | 0.56 | -100.98 | -102.87 | -1.03 | 1.89 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2025-06-10T00:00:00+00:00 | 21.79 | 19.25 | 40.57 | -102.96 | -104.09 | -1.02 | 1.13 | Stop loss hit. |
| `SUIUSDT` | STOPPED（已止损） | 2025-06-10T04:00:00+00:00 | 3.41 | 3.13 | 370.39 | -104.94 | -106.60 | -1.03 | 1.66 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-24T16:00:00+00:00 | 105,613.24 | 96,630.27 | 0.01 | -98.15 | -99.66 | -1.03 | 1.52 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-29T08:00:00+00:00 | 2,449.05 | 2,734.86 | 0.96 | 273.91 | 271.93 | 2.77 | 1.99 | TP2 hit; paper trade closed. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.25 | 1,877.85 | -97.49 | -98.18 | -1.01 | 0.68 | Stop loss hit. |
| `SUIUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2.91 | 3.97 | 265.47 | 280.92 | 280.19 | 2.87 | 0.73 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T12:00:00+00:00 | 0.85 | 1.12 | 946.63 | 259.57 | 258.82 | 2.62 | 0.75 | TP2 hit; paper trade closed. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-11T00:00:00+00:00 | 512.91 | 486.01 | 3.96 | -106.67 | -109.41 | -1.04 | 2.74 | Stop loss hit. |
| `ARKUSDT` | STOPPED（已止损） | 2025-07-13T04:00:00+00:00 | 0.46 | 0.37 | 1,233.50 | -107.18 | -107.87 | -1.01 | 0.69 | Stop loss hit. |
| `ADAUSDT` | CLOSED（已按TP2平仓） | 2025-07-14T12:00:00+00:00 | 0.74 | 0.88 | 1,758.14 | 258.02 | 256.88 | 2.45 | 1.14 | TP2 hit; paper trade closed. |
| `WLDUSDT` | CLOSED（已按TP2平仓） | 2025-07-16T12:00:00+00:00 | 1.08 | 1.32 | 1,092.87 | 264.27 | 263.23 | 2.46 | 1.05 | TP2 hit; paper trade closed. |
| `SUIUSDT` | STOPPED（已止损） | 2025-07-16T16:00:00+00:00 | 3.94 | 3.37 | 192.30 | -110.00 | -110.95 | -1.01 | 0.95 | Stop loss hit. |
| `BONKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 0.00 | 0.00 | 30,762,860.37 | -110.36 | -111.75 | -1.02 | 1.39 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2025-07-22T00:00:00+00:00 | 19.38 | 17.25 | 53.24 | -113.27 | -114.60 | -1.02 | 1.33 | Stop loss hit. |
| `PENGUUSDT` | STOPPED（已止损） | 2025-07-28T00:00:00+00:00 | 0.04 | 0.04 | 13,486.32 | -109.09 | -109.79 | -1.01 | 0.70 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 3,436.89 | -107.28 | -108.18 | -1.01 | 0.90 | Stop loss hit. |
| `ENAUSDT` | STOPPED（已止损） | 2025-07-31T00:00:00+00:00 | 0.61 | 0.52 | 1,221.54 | -104.87 | -105.81 | -1.02 | 0.94 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 13.69 | -107.35 | -109.57 | -1.04 | 2.22 | Stop loss hit. |
| `OPUSDT` | STOPPED（已止损） | 2025-08-14T08:00:00+00:00 | 0.83 | 0.71 | 896.57 | -105.23 | -106.17 | -1.01 | 0.93 | Stop loss hit. |
| `BERAUSDT` | CLOSED（已按TP2平仓） | 2025-08-15T08:00:00+00:00 | 2.15 | 2.96 | 353.72 | 288.22 | 287.49 | 2.81 | 0.72 | TP2 hit; paper trade closed. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 659.30 | -103.46 | -104.22 | -1.01 | 0.76 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-08-26T20:00:00+00:00 | 4,612.80 | 4,242.13 | 0.28 | -102.81 | -104.50 | -1.03 | 1.69 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2025-09-16T12:00:00+00:00 | 0.35 | 0.34 | 11,454.90 | -107.20 | -112.64 | -1.09 | 5.44 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-10-01T12:00:00+00:00 | 4,306.31 | 3,902.60 | 0.25 | -102.06 | -103.48 | -1.02 | 1.42 | Stop loss hit. |
| `SOLUSDT` | STOPPED（已止损） | 2025-10-02T00:00:00+00:00 | 220.00 | 201.02 | 5.41 | -102.70 | -104.26 | -1.03 | 1.56 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-10-09T04:00:00+00:00 | 118.79 | 113.32 | 18.15 | -99.40 | -102.32 | -1.05 | 2.92 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-10-26T16:00:00+00:00 | 4,060.46 | 3,757.68 | 0.32 | -97.19 | -98.91 | -1.03 | 1.73 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-11-27T16:00:00+00:00 | 2,996.52 | 2,797.38 | 0.47 | -94.51 | -96.41 | -1.03 | 1.90 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-11-30T04:00:00+00:00 | 91,152.21 | 88,714.33 | 0.04 | -97.91 | -102.93 | -1.09 | 5.03 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-12-03T08:00:00+00:00 | 93,325.63 | 82,482.85 | 0.01 | -91.57 | -92.58 | -1.02 | 1.01 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-12-07T20:00:00+00:00 | 3,107.08 | 2,861.04 | 0.37 | -91.88 | -93.41 | -1.03 | 1.53 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-12-31T00:00:00+00:00 | 2,984.10 | 3,318.38 | 0.77 | 256.82 | 254.89 | 2.82 | 1.94 | TP2 hit; paper trade closed. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-17T16:00:00+00:00 | 3,319.13 | 3,201.01 | 0.81 | -96.22 | -99.91 | -1.07 | 3.69 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 2.68 | -95.91 | -99.36 | -1.06 | 3.44 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 0.31 | 0.30 | 6,098.29 | -92.42 | -94.99 | -1.05 | 2.57 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 9.21 | -93.51 | -94.45 | -1.02 | 0.94 | Stop loss hit. |
| `ICPUSDT` | STOPPED（已止损） | 2026-01-19T08:00:00+00:00 | 4.16 | 3.39 | 118.37 | -90.74 | -91.34 | -1.01 | 0.60 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 18,675.36 | -87.95 | -88.29 | -1.01 | 0.34 | Stop loss hit. |
| `PEPEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.00 | 0.00 | 287,823,017.67 | 220.13 | 219.19 | 2.48 | 0.94 | TP2 hit; paper trade closed. |
| `SOLUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 85.20 | 98.36 | 17.82 | 234.50 | 233.19 | 2.61 | 1.31 | TP2 hit; paper trade closed. |
| `DOGEUSDT` | CLOSED（已按TP2平仓） | 2026-04-16T00:00:00+00:00 | 0.09 | 0.11 | 16,222.11 | 227.86 | 226.54 | 2.53 | 1.32 | TP2 hit; paper trade closed. |
| `ZECUSDT` | STOPPED（已止损） | 2026-05-10T16:00:00+00:00 | 598.44 | 540.82 | 1.68 | -96.70 | -98.01 | -1.02 | 1.31 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-05-11T00:00:00+00:00 | 0.00 | 0.00 | 288,637,233.62 | -96.26 | -97.92 | -1.03 | 1.66 | Stop loss hit. |
| `XRPUSDT` | STOPPED（已止损） | 2026-05-12T04:00:00+00:00 | 1.46 | 1.39 | 1,256.15 | -95.56 | -98.04 | -1.05 | 2.48 | Stop loss hit. |
...
| `ZBTUSDT` | ENTERED（已入场） | 0.17 | 1,744.79 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T08:09:41+00:00",
