...
| Open trades（仍开放持仓） | 2 |
| Win rate（胜率） | 10.53% |
| Profit factor（盈利因子） | 0.32 |
| Avg R（平均R倍数） | -0.64 |
| Net return（净收益率） | -22.71% |
| Max drawdown（最大回撤） | 3,038.98 / 28.30% |
| Intrabar max drawdown（K线内最大回撤） | 2,960.32 / 27.81% |
| TP1 touched rate（第一止盈触达率） | 28.95% |
| TP2 close rate（第二止盈平仓率） | 10.53% |
| Stop rate（止损率） | 89.47% |
| Fee drag（手续费拖累） | 65.45 USDT |
| Tail max single loss（最大单笔亏损） | -107.79 USDT |
| CAGR（年化复合收益率） | -22.71% |
| Sharpe（夏普比率） | -1.43 |
| Sortino（索提诺比率） | -1.48 |
| Exposure（持仓暴露时间） | 66.67% |
| Turnover（换手率） | 5.24 |
...
| `BNBUSDT` | STOPPED（已止损） | 2025-06-10T12:00:00+00:00 | 660.52 | 636.16 | 4.23 | -102.99 | -106.80 | -1.06 | 3.81 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2025-06-24T16:00:00+00:00 | 105,613.24 | 96,630.27 | 0.01 | -97.35 | -98.85 | -1.03 | 1.50 | Stop loss hit. |
| `SEIUSDT` | STOPPED（已止损） | 2025-06-30T00:00:00+00:00 | 0.30 | 0.25 | 1,862.05 | -96.67 | -97.35 | -1.01 | 0.68 | Stop loss hit. |
| `ETHUSDT` | CLOSED（已按TP2平仓） | 2025-06-30T00:00:00+00:00 | 2,486.81 | 2,872.34 | 0.69 | 267.13 | 265.64 | 2.74 | 1.49 | TP2 hit; paper trade closed. |
| `UNIUSDT` | STOPPED（已止损） | 2025-06-30T04:00:00+00:00 | 7.20 | 6.67 | 182.76 | -97.87 | -99.62 | -1.03 | 1.75 | Stop loss hit. |
| `BCHUSDT` | STOPPED（已止损） | 2025-07-01T00:00:00+00:00 | 505.13 | 479.22 | 3.73 | -96.57 | -99.11 | -1.05 | 2.54 | Stop loss hit. |
| `XRPUSDT` | CLOSED（已按TP2平仓） | 2025-07-03T12:00:00+00:00 | 2.25 | 2.60 | 704.54 | 249.30 | 247.94 | 2.62 | 1.37 | TP2 hit; paper trade closed. |
| `WIFUSDT` | CLOSED（已按TP2平仓） | 2025-07-06T20:00:00+00:00 | 0.88 | 1.07 | 1,253.02 | 245.37 | 244.39 | 2.51 | 0.98 | TP2 hit; paper trade closed. |
| `AAVEUSDT` | STOPPED（已止损） | 2025-07-11T04:00:00+00:00 | 301.27 | 274.69 | 3.89 | -103.31 | -104.85 | -1.03 | 1.54 | Stop loss hit. |
| `FETUSDT` | STOPPED（已止损） | 2025-07-11T16:00:00+00:00 | 0.73 | 0.65 | 1,368.33 | -104.28 | -105.56 | -1.02 | 1.29 | Stop loss hit. |
| `ARKUSDT` | STOPPED（已止损） | 2025-07-13T04:00:00+00:00 | 0.46 | 0.37 | 1,219.10 | -105.93 | -106.61 | -1.01 | 0.68 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-07-27T20:00:00+00:00 | 3,787.59 | 3,516.63 | 0.38 | -102.64 | -104.55 | -1.03 | 1.91 | Stop loss hit. |
| `CFXUSDT` | STOPPED（已止损） | 2025-07-29T20:00:00+00:00 | 0.21 | 0.18 | 3,183.33 | -99.36 | -100.20 | -1.01 | 0.83 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-08-08T00:00:00+00:00 | 121.19 | 113.35 | 13.03 | -102.17 | -104.27 | -1.04 | 2.11 | Stop loss hit. |
| `WIFUSDT` | STOPPED（已止损） | 2025-08-23T00:00:00+00:00 | 0.94 | 0.78 | 626.30 | -98.28 | -99.01 | -1.01 | 0.72 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-08-26T20:00:00+00:00 | 4,612.80 | 4,242.13 | 0.26 | -97.41 | -99.01 | -1.03 | 1.60 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-09-05T08:00:00+00:00 | 4,432.76 | 4,189.79 | 0.40 | -96.93 | -99.31 | -1.04 | 2.38 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2025-09-21T12:00:00+00:00 | 1,025.08 | 958.33 | 1.43 | -95.39 | -97.35 | -1.04 | 1.96 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2025-10-01T12:00:00+00:00 | 4,306.31 | 3,902.60 | 0.23 | -94.50 | -95.81 | -1.02 | 1.32 | Stop loss hit. |
| `LTCUSDT` | STOPPED（已止损） | 2025-10-08T20:00:00+00:00 | 119.08 | 113.32 | 16.11 | -92.74 | -95.33 | -1.05 | 2.59 | Stop loss hit. |
| `BTCUSDT` | STOPPED（已止损） | 2026-01-09T04:00:00+00:00 | 91,539.64 | 87,883.36 | 0.02 | -90.55 | -93.63 | -1.06 | 3.08 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-01-17T16:00:00+00:00 | 3,319.13 | 3,201.01 | 0.78 | -91.94 | -95.47 | -1.07 | 3.53 | Stop loss hit. |
| `BNBUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 944.78 | 908.92 | 2.56 | -91.64 | -94.92 | -1.06 | 3.29 | Stop loss hit. |
| `TRXUSDT` | STOPPED（已止损） | 2026-01-18T00:00:00+00:00 | 0.31 | 0.30 | 5,802.08 | -87.93 | -90.38 | -1.05 | 2.45 | Stop loss hit. |
| `DASHUSDT` | STOPPED（已止损） | 2026-01-18T12:00:00+00:00 | 80.43 | 70.28 | 8.80 | -89.32 | -90.22 | -1.02 | 0.90 | Stop loss hit. |
| `ICPUSDT` | STOPPED（已止损） | 2026-01-19T08:00:00+00:00 | 4.16 | 3.39 | 112.65 | -86.36 | -86.93 | -1.01 | 0.57 | Stop loss hit. |
| `ROSEUSDT` | STOPPED（已止损） | 2026-01-20T12:00:00+00:00 | 0.02 | 0.01 | 17,682.58 | -83.28 | -83.60 | -1.01 | 0.33 | Stop loss hit. |
| `ETHUSDT` | STOPPED（已止损） | 2026-04-09T16:00:00+00:00 | 2,205.66 | 2,027.31 | 0.46 | -82.33 | -83.68 | -1.03 | 1.34 | Stop loss hit. |
| `AVAXUSDT` | STOPPED（已止损） | 2026-04-17T00:00:00+00:00 | 9.63 | 9.06 | 149.19 | -83.99 | -85.92 | -1.04 | 1.93 | Stop loss hit. |
| `LINKUSDT` | STOPPED（已止损） | 2026-04-17T00:00:00+00:00 | 9.38 | 8.79 | 142.01 | -83.93 | -85.72 | -1.04 | 1.78 | Stop loss hit. |
| `PEPEUSDT` | STOPPED（已止损） | 2026-04-17T08:00:00+00:00 | 0.00 | 0.00 | 195,632,448.19 | -83.49 | -84.47 | -1.02 | 0.98 | Stop loss hit. |

## 回测结束仍开放

| Symbol（交易对） | Status（状态） | Entry（入场价） | Qty（数量） | Unrealized Handling（未实现盈亏处理） | Notes（备注） |
|---|---|---:|---:|---|---|
| `BTCUSDT` | TP1_HIT（第一止盈已触达） | 71,656.66 | 0.02 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
| `BOMEUSDT` | ENTERED（已入场） | 0.00 | 840,400.03 | 按最后 close 计入净值，不计入胜率/profit_factor/avg_R | Open at backtest end; mark-to-market only. |
...
| `SUIUSDT` | INVALIDATED（未入场前失效） | 2025-07-17T12:00:00+00:00 | 3.91 - 3.99 | 70.50 | Plan invalidated before entry: current price is below stop loss. |
...
| `SOLUSDT` | EXPIRED（观察计划过期） | 2025-10-02T00:00:00+00:00 | 217.32 - 219.89 | 71.54 | Backtest WATCHING plan expired before entry. |
...
| `SOLUSDT` | INVALIDATED（未入场前失效） | 2025-10-05T04:00:00+00:00 | 227.24 - 229.95 | 56.94 | Plan invalidated before entry: current price is below stop loss. |
...
```json
{
  ...
  "dynamic_universe_summary": {
    ...
    "created_at_utc": "2026-06-11T06:55:11+00:00",
