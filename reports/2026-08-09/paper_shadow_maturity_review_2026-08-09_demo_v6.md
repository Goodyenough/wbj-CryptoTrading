...
| decisions | 141 |
| opportunities | 31 |
| candidate-only rows | 90 |
| plan-linked decision rows | 51 |
| mature terminal rows | 0 |
| right-censored open rows | 51 |
| unknown plan rows | 0 |
...
- latest_scan: `e6059958bb9f` at `2026-08-09T12:05:57+00:00`
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-08-09T12:05:57Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 47 |
| `reference_baseline` | 47 |
| `research_incumbent` | 47 |

## By Opportunity

| Opportunity | Rows | Lines | Maturity | Capacity | Scanner action |
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 51 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:51` | `capacity_available:51` | `unknown:51` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 90 |
| `decision_level_unknown` | 51 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 141 |
