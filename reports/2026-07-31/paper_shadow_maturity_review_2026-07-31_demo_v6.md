...
| plan-linked decision rows | 9 |
| mature terminal rows | 0 |
| right-censored open rows | 9 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 9 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:9` | `capacity_available:9` | `unknown:9` |
