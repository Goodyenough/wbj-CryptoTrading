...
| plan-linked decision rows | 6 |
| mature terminal rows | 0 |
| right-censored open rows | 6 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 6 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:6` | `capacity_available:6` | `unknown:6` |
