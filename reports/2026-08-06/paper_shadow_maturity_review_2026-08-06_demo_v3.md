...
| decisions | 123 |
| opportunities | 26 |
| candidate-only rows | 75 |
| plan-linked decision rows | 48 |
| mature terminal rows | 0 |
| right-censored open rows | 48 |
| unknown plan rows | 0 |
...
- latest_scan: `af613d2bf39b` at `2026-08-05T14:23:11+00:00`
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 48 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:48` | `capacity_available:48` | `unknown:48` |
...
| Stage | Count |
|---|---:|
| `daily_import_candidate_context` | 75 |
| `decision_level_unknown` | 48 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 123 |
