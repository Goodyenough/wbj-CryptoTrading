...
|---|---|---|---|---|
| `daily_full` | `20260717_120503_85cf66a6` | running | 2026-07-17 20:05:03 CST | n/a |
| `paper_4h_update` | `20260717_081004_3e549d62` | success | 2026-07-17 16:10:04 CST | 2026-07-17 16:10:10 CST |
...
| `WLDUSDT` | `616e1bbfd4c6` | ENTERED | 2026-06-18 20:07:18 CST (176.5h) | 0.628200 | 120.13 | 0.382100 | -53.88 | 0.645900 / 0.359600 | 132.65 / -69.79 | still_open |

## 开放持仓时长

| Symbol | Status | Holding Hours |
|---|---|---:|
| `WLDUSDT` | ENTERED | 872.5 |

## 今日扫描 Action 与 RISK_OFF

| Scope | BUY_CANDIDATE | WAIT_PULLBACK | WATCH_ONLY | REJECT | Other |
|---|---:|---:|---:|---:|---:|
| All candidates | 0 | 1 | 3 | 1 | 0 |
| RISK_OFF-tagged | 0 | 1 | 3 | 1 | 0 |

## RECLAIM_PENDING 明细

| Symbol | Status | Stop | Last Price | Outcome | Last Pending |
|---|---|---:|---:|---|---|
| `ONDOUSDT` | WATCHING | 0.338446 | 0.3813 | still_waiting | 2026-07-17 20:06:35 CST |
