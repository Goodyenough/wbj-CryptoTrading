...
| plan-linked decision rows | 18 |
| mature terminal rows | 0 |
| right-censored open rows | 18 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 18 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:18` | `capacity_available:18` | `unknown:18` |
...
| `decision_level_unknown` | 18 |

## By Capacity State

| Capacity state | Count |
|---|---:|
| `capacity_available` | 48 |
