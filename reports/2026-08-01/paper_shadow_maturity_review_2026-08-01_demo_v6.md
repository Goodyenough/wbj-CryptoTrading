...
| plan-linked decision rows | 27 |
| mature terminal rows | 0 |
| right-censored open rows | 27 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 27 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:27` | `capacity_available:27` | `unknown:27` |
