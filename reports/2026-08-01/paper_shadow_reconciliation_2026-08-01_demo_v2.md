...
- latest_4h_run: `20260731_201002_b2863416` status=`success`
- open_plan_count: 1
...
|---|---|---|---:|---:|---|
| `9734a33dea2e` | `ONDOUSDT` | `WATCHING` | 0.394505 | 0.41156785714285715 | 2026-07-31T20:10:02Z |

## By Line

| Line | Count |
|---|---:|
| `atr_reclaim_0_35_shadow` | 15 |
| `reference_baseline` | 15 |
| `research_incumbent` | 15 |
...
|---|---:|
| `candidate_level` | 30 |
| `paper_4h_decision` | 15 |

## By Decision

| Decision | Count |
|---|---:|
| `candidate_registered` | 30 |
| `reject` | 15 |
...
|---|---:|---|---|---|---|---|---|---|
| `paper_plan:9734a33dea2e` | 15 | `ONDOUSDT` | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `none` | `atr_reclaim_0_35_shadow:reject,reference_baseline:reject,research_incumbent:reject` | `atr_reclaim_0_35_shadow:0,reference_baseline:0,research_incumbent:0` | `right_censored_open` | `WATCHING` |
