...
| plan-linked decision rows | 15 |
| mature terminal rows | 0 |
| right-censored open rows | 15 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 15 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:15` | `capacity_available:15` | `unknown:15` |
