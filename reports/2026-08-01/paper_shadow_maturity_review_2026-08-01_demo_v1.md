...
| plan-linked decision rows | 12 |
| mature terminal rows | 0 |
| right-censored open rows | 12 |
| unknown plan rows | 0 |
...
|---|---:|---|---|---|---|
| `paper_plan:9734a33dea2e` | 12 | `atr_reclaim_0_35_shadow,reference_baseline,research_incumbent` | `right_censored_open:12` | `capacity_available:12` | `unknown:12` |
